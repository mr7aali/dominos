...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez blue_cheese_dipping_cup online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSidesFBdBlueCheeseDippingCupPage() {
  return (
    <>
    <div>
