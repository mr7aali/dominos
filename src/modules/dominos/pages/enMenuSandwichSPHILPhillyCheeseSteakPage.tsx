...
export const metadata: Metadata = {
  "title": "Philly Cheese Steak Sandwich Near Me | Crumblez",
  "description": "Order your favorite Crumblez Philly Cheese Steak sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSandwichSPHILPhillyCheeseSteakPage() {
  return (
    <>
    <div>
