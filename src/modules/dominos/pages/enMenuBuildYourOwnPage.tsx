...
export const metadata: Metadata = {
  "title": "Build Your Own Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez build your own pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuBuildYourOwnPage() {
  return (
    <>
    <div>
