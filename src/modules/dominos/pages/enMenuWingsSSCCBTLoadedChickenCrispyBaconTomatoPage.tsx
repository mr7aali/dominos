...
export const metadata: Metadata = {
  "title": "Crispy Bacon & Tomato Specialty Chicken | Crumblez",
  "description": "Order your favorite Crumblez Crispy Bacon & Tomato Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
