...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez caesar_dressing online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSidesFCAESARCaesarDressingPage() {
  return (
    <>
    <div>
