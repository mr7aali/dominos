...
export const metadata: Metadata = {
  "title": "Dasani Bottled Water Near Me | Crumblez",
  "description": "Order your favorite Crumblez Dasani Bottled Water online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
