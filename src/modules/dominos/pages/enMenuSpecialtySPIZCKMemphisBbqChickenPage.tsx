...
export const metadata: Metadata = {
  "title": "Memphis BBQ Chicken Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez Memphis BBQ Chicken pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySPIZCKMemphisBbqChickenPage() {
  return (
    <>
    <div>
