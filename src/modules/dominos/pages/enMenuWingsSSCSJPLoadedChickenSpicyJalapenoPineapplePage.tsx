...
export const metadata: Metadata = {
  "title": "Spicy Jalapeno Pineapple Specialty Chicken | Crumblez",
  "description": "Order your favorite Crumblez Spicy Jalapano Pineapple Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuWingsSSCSJPLoadedChickenSpicyJalapenoPineapplePage() {
  return (
    <>
    <div>
