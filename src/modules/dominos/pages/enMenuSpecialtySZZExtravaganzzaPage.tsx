...
export const metadata: Metadata = {
  "title": "ExtravaganZZa Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez ExtravaganZZa pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySZZExtravaganzzaPage() {
  return (
    <>
    <div>
