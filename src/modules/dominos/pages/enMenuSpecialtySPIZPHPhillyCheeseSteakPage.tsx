...
export const metadata: Metadata = {
  "title": "Philly Cheese Steak Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez Philly Cheese Steak pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
