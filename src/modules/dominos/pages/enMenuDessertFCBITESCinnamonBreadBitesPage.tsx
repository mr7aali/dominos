...
export const metadata: Metadata = {
  "title": "Cinnamon Bread Bites Near Me | Crumblez",
  "description": "Order your favorite Crumblez Cinnamon Bread Bites online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuDessertFCBITESCinnamonBreadBitesPage() {
  return (
    <>
    <div>
