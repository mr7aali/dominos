...
export const metadata: Metadata = {
  "title": "Plain Wings Near Me  | Crumblez",
  "description": "Order your favorite Crumblez Plain wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuWingsSPLNWINGSPlainWingsPage() {
  return (
    <>
    <div>
