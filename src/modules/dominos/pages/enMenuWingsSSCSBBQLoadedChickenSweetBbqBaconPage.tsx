...
export const metadata: Metadata = {
  "title": "Sweet BBQ Bacon Specialty Chicken | Crumblez",
  "description": "Order your favorite Crumblez Sweet BBQ Bacon Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuWingsSSCSBBQLoadedChickenSweetBbqBaconPage() {
  return (
    <>
    <div>
