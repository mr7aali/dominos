...
export const metadata: Metadata = {
  "title": "MeatZZa Near Me | Crumblez",
  "description": "Order your favorite Crumblez MeatZZa pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySMXMeatzzaPage() {
  return (
    <>
    <div>
