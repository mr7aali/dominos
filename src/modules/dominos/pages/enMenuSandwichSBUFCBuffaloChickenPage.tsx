...
export const metadata: Metadata = {
  "title": "Buffalo Chicken Sandwich Near Me | Crumblez",
  "description": "Order your favorite Crumblez Buffalo Chicken sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSandwichSBUFCBuffaloChickenPage() {
  return (
    <>
    <div>
