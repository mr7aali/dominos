...
export const metadata: Metadata = {
  "title": "Fanta Orange Near Me | Crumblez",
  "description": "Order your favorite Crumblez Fanta Orange online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
