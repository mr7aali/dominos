...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez the_peoples_pizza_deluxe online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySDXThePeoplesPizzaDeluxePage() {
  return (
    <>
    <div>
