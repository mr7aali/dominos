...
export const metadata: Metadata = {
  "title": "Garlic Bread Bites Near Me | Crumblez",
  "description": "Order your favorite Crumblez Garlic Bread Bites online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
