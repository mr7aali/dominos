...
export const metadata: Metadata = {
  "title": "Drinks Near Me | Crumblez",
  "description": "Complete your order with Crumblez drinks & beverages. Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuDrinks32f4Page() {
  return (
    <>
    <div>
