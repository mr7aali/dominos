...
export const metadata: Metadata = {
  "title": "Sprite Near Me | Crumblez",
  "description": "Order your favorite Crumblez Sprite online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuDrinksFSPRITESpritePage() {
  return (
    <>
    <div>
