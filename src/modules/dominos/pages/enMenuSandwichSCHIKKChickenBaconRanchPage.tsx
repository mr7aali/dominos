...
export const metadata: Metadata = {
  "title": "Chicken Bacon Ranch Sandwich Near Me | Crumblez",
  "description": "Order your favorite Crumblez Chicken Bacon Ranch sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSandwichSCHIKKChickenBaconRanchPage() {
  return (
    <>
    <div>
