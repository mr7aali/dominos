...
export const metadata: Metadata = {
  ...
  description:
    "Order Crumblez pizza, pasta, sandwiches & more, available for carryout or delivery. Sign up for Crumblez email & text offers for great deals on your next order.",
  alternates: {
    canonical: "/en/menu",
  },
  robots: "index",
        ...
        <section className="sh-bg-primary sh-flex sh-h-full sh-flex-col sh-typo-body-1">
          <main className="sh-min-h-[400px]" id="main-content">
            <section className="sh-m-auto">
              <header
                className="pd-fixed pd-inset-x-none pd-top-none pd-z-20 pd-bg-neutral-white pd-transition-transform -pd-translate-y-full"
                aria-hidden="false"
              >
                      ...
                      <div className="md:pd-p-x-small md:pd-px-none">
                        <ul className="flex w-fit flex-row items-center justify-start gap-small">
                          ...
                          <li className="rounded-full border-2 px-medium py-small text-center outline-none typo-label-4 focus:shadow-button-tertiary border-cool-gray-400 bg-transparent text-text-primary">
                            <Link href="/menu/previous">{"Recent items"}</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="bg-background-primary lg:flex lg:flex-col">
                <div className="flex w-full max-w-screen-xl flex-col gap-xx-large self-center px-medium pb-xx-large pt-x-large md:gap-mega-1 md:px-x-large md:pb-mega-1 lg:gap-mega-1 lg:pb-mega-1 lg:pt-mega-1">
                  ...
                  <div className="pd-flex pd-flex-col pd-gap-y-mega-1">
                    ...
                    <div
                      className="clickable-card pd-overflow-hidden pd-rounded-xl pd-bg-cool-gray-200 pd-outline-dark-blue focus-within:pd-outline-2 active:pd-outline-blue active:outline active:outline-blue"
                      data-testid="clickable-card"
                    >
                      <article
                        className="pd-flex pd-flex-col md:pd-flex-row md:pd-justify-between"
                        data-testid="build-your-own-pizza-banner"
                      >
                        <picture className="pd-order-1 md:pd-order-2">
                          <source
                            media="(min-width: 1700px)"
                            srcSet="/site-assets/cms/assets/e8e0ce5e-13d1-4b64-865e-9e02345398eab10d.png?im=Resize=(717,717);Crop,rect=(11,280,639,274),allowExpansion"
                          />
                          <source
                          ...
                          <source
                            ...
                            srcSet="/site-assets/cms/assets/e8e0ce5e-13d1-4b64-865e-9e02345398eab10d.png?im=Resize=(436,436);Crop,rect=(0,125,305,244),allowExpansion"
                          />
                          <source
                            media="(max-width: 500px)"
                            srcSet="/site-assets/cms/assets/e8e0ce5e-13d1-4b64-865e-9e02345398eab10d.png?im=Resize=(436,436);Crop,rect=(43,185,350,150),allowExpansion"
                          />
                          <img
                            src="/site-assets/cms/assets/e8e0ce5e-13d1-4b64-865e-9e02345398eab10d.png?im=Resize=(436,436);Crop,rect=(43,185,350,150),allowExpansion"
                            alt=""
                            className="pd-w-full pd-object-cover pd-object-center md:pd-w-auto"
                          />
                        </picture>
                      ...
                      >
                        <div className="grid h-full">
                          <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                            ...
                            />
                            <img
                              src="/site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b66b14.jpg?im=Crop,rect=(248,548,3203,1421);Resize=(1700),allowExpansion"
                              alt="Mix and match"
                              loading="lazy"
                              ...
                              <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                  ...
                                  <div className="cp-mt-tiny">
                                    <button
                                      type="button"
                                      aria-labelledby=":R3l5ldmf6H1: :R3l5ldmf6:"
                                      id=":R3l5ldmf6H1:"
                      ...
                      <div className="sm:flex-col mt-small flex items-center gap-x-small">
                        <div>
                          <div className="inline-block whitespace-nowrap">
                            <button
                              type="button"
                              aria-labelledby=":R3l5ldmf6H2: :R3l5ldmf6:"
                            ...
                            >
                              <span id=":R3l5ldmf6H2:">{"Offer details"}</span>
                            </button>
                          </div>
                        </div>
