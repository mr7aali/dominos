...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez bread?type=order_delivery online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuBread32f4Page() {
  return (
    <>
    <div>
