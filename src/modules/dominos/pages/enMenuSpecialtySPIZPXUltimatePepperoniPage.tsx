...
export const metadata: Metadata = {
  "title": "Ultimate Pepperoni Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez Ultimate Pepperoni pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
