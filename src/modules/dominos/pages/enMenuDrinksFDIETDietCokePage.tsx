...
export const metadata: Metadata = {
  "title": "Diet Coke Near Me | Crumblez",
  "description": "Order your favorite Crumblez Diet Coke online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
