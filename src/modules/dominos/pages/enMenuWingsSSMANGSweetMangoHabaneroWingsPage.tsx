...
export const metadata: Metadata = {
  "title": "Sweet Mango Habanero Wings Near Me | Crumblez",
  "description": "Order your favorite Crumblez Sweet Mango Habanero wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
