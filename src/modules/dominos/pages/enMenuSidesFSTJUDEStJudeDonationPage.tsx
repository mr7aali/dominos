...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez st_jude_donation online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSidesFSTJUDEStJudeDonationPage() {
  return (
    <>
    <div>
