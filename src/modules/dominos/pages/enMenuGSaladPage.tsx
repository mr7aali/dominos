...
export const metadata: Metadata = {
  "title": "Salads Near Me | Crumblez",
  "description": "Order your favorite Crumblez Classic Garden or Chicken Caesar salad online. Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuGSaladPage() {
  return (
    <>
    <div>
