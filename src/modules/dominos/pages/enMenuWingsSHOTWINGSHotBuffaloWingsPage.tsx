...
export const metadata: Metadata = {
  "title": "Hot Buffalo Wings Near Me | Crumblez",
  "description": "Order your favorite Crumblez Hot Buffalo wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuWingsSHOTWINGSHotBuffaloWingsPage() {
  return (
    <>
    <div>
