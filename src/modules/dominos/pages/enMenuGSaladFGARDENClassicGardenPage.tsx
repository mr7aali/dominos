...
export const metadata: Metadata = {
  "title": "Classic Garden Salad Near Me | Crumblez",
  "description": "Order your favorite Crumblez Classic Garden salad online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
