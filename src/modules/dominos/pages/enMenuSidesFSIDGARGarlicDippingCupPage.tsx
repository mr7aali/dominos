...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez garlic_dipping_cup online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSidesFSIDGARGarlicDippingCupPage() {
  return (
    <>
    <div>
