...
export const metadata: Metadata = {
  "title": "Coke Near Me | Crumblez",
  "description": "Order your favorite Crumblez Coke online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuDrinksFCOKECokePage() {
  return (
    <>
    <div>
