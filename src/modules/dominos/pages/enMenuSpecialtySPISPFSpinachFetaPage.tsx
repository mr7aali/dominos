...
export const metadata: Metadata = {
  "title": "Spinach & Feta Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez Spinach & Feta pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySPISPFSpinachFetaPage() {
  return (
    <>
    <div>
