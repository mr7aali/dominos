...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez spicy_chicken_bacon_ranch online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySPIZSCSpicyChickenBaconRanchPage() {
  return (
    <>
    <div>
