...
export const metadata: Metadata = {
  "title": "Classic Hot Buffalo Specialty Chicken | Crumblez",
  "description": "Order your favorite Crumblez Hot Buffalo Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuWingsSSCCHBLoadedChickenClassicHotBuffaloPage() {
  return (
    <>
    <div>
