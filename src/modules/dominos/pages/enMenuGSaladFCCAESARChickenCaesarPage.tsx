...
export const metadata: Metadata = {
  "title": "Chicken Caesar Salad Near Me | Crumblez",
  "description": "Order your favorite Crumblez Chicken Caesar salad online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
