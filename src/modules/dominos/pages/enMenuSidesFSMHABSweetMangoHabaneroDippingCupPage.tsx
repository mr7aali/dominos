...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez sweet_mango_habanero_dipping_cup online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSidesFSMHABSweetMangoHabaneroDippingCupPage() {
  return (
    <>
    <div>
