...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical": "/en/content/terms-of-use"
  },
  "robots": "index"
};

export function EnContentTermsOfUsePage() {
  return (
    <>
    <div>
              ...
              <div className="flex w-full max-w-screen-xl flex-col gap-xx-large self-center px-medium pb-xx-large pt-x-large md:gap-mega-1 md:px-x-large md:pb-mega-1 lg:gap-mega-1 lg:pb-mega-1 lg:pt-mega-1">
                <div className="sh-p-regular">
                  <div>
                    ...
                    <h2 id="acceptance-of-terms-of-use" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Acceptance of Terms of Use"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"These Terms of Use govern your use of the online and mobile web site (the “Website” or, collectively, the \"Websites\"), and the tablet, smartphone and other applications and platforms, including but not limited to the "}
                      <a href="https://anyware.dominos.com/" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"Crumblez Anyware platform"}
                      </a>
                      {", available through third party devices, (the \"Application\" or, collectively, the \"Applications\"), owned and/or operated by Crumblez, Inc. and its affiliates and franchisees (hereinafter “Crumblez” or \"Crumblez\"). If you do not agree to these Terms of Use, you should not use the Websites or Applications. These Terms of Use are an ongoing contract between you and Crumblez and apply to your use of the Websites or Applications. These Terms of Use affect your rights and you should read them carefully."}
                    </p>
                    <h2 id="changes-to-terms-of-use" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Changes to Terms of Use"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Crumblez reserves the right, from time to time, with or without notice to you, to change these Terms of Use (other than the arbitration provision) in our sole and absolute discretion. The most current version of these Terms of Use can be reviewed by clicking on the \"Terms of Use\" located at the bottom of the pages of the online Website or on the Applications. The most current version of the Terms of Use will supersede all previous versions."}
                    </p>
                    <h2 id="privacy-and-personal-information" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Privacy and Personal Information"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Crumblez is committed to protecting the privacy of the personal information you provide us on our Websites and Applications. Any information submitted on the Websites and Applications is subject to our Privacy Policy, the terms of which are incorporated herein. Please review our Privacy Policy to understand our practices. The date of any changes to our Privacy Policy will be noted at the bottom of our Privacy Policy."}
                    </p>
                    <h2 id="your-account" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Your Account"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"If you use the Websites or Applications, you are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer, smartphone or tablet, and you agree to accept responsibility for all activities that occur under your account or password. The Websites and Applications sell products to adults, who can purchase with a credit card. If you are under 18, you may use the Websites and Applications only with involvement of a parent or guardian. Crumblez and its affiliates reserve the right to refuse service, terminate accounts, remove or edit content, or cancel orders in their sole discretion."}
                    </p>
                    <h2 id="dominos-pizza-websites-and-applications" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Crumblez Websites and Applications"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"These Terms of Use apply to all users of the Websites and Applications, including users who are also contributors of video content, voice content, information, and other materials or services on the Websites or Applications. The Websites and Applications may contain links to third party websites or applications, or may be made available through third party devices, that are not owned or controlled by Crumblez. Crumblez has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party websites, applications or devices. In addition, Crumblez will not and cannot censor or edit the content of any third-party site, application or device. By using the Websites or Applications, you expressly relieve Crumblez from any and all liability arising from your use of any third-party website, application or device. Accordingly, we encourage you to be aware when you leave the Websites or Applications and to read the terms and conditions and privacy policy of each other website, application and device that you visit."}
                    </p>
                    <h2 id="websiteapplication-access" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Website/Application Access"}
                    </h2>
                    <ol start="1" className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1 sh-list-decimal sh-space-y-small sh-ml-regular sh-pl-regular">
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"Crumblez hereby grants you permission to use the Websites and Applications as set forth in this Terms of Use, provided that: (i) your use of the Websites and Applications as permitted are solely for your personal, noncommercial use; (ii) you will not copy or distribute any part of the Websites or Applications in any medium without Crumblez prior written authorization; (iii) you will not alter or modify any part of the Websites or Applications other than as may be reasonably necessary to use the Websites or Applications for their intended purpose; and (iv) you will otherwise comply with the terms and conditions of these Terms of Use."}
                        </p>
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"In order to access some features of the Websites or Applications, you will have to create an account. You may never use another's account without permission. When creating your account, you must provide accurate and complete information. You are solely responsible for the activity that occurs on your account, and you must keep your account password secure. You must notify Crumblez immediately of any breach of security or unauthorized use of your account. Although Crumblez will not be liable for your losses caused by any unauthorized use of your account, you may be liable for the losses of Crumblez or others due to such unauthorized use."}
                        </p>
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"You agree not to use or launch any automated system, including without limitation, \"robots,\" \"spiders,\" \"offline readers,\" etc., that accesses the Websites or Applications in a manner that sends more request messages to the Crumblez servers in a given period of time than a human can reasonably produce in the same period by using a convention on-line web browser. Notwithstanding the foregoing, Crumblez grants the operators of public search engines permission to use spiders to copy materials from the site for the sole purpose of creating publicly available searchable indices of the materials, but not caches or archives of such materials. Crumblez reserves the right to revoke these exceptions either generally or in specific cases. You agree not to collect or harvest any personally identifiable information, including account names, from the Websites or Applications, nor to use the communication systems provided by the Websites or Applications for any commercial solicitation purposes. You agree not to solicit, for commercial purposes, any users of the Websites or Applications with respect to their User Submissions."}
                        </p>
                      </li>
                    </ol>
                    <h2 id="intellectual-property-rights" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Intellectual Property Rights"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"The content on the Websites and Applications, except all User Submissions (as defined below), including without limitation, the text, software, scripts, graphics, photos, sounds, music, videos, interactive features and the like (\"Content\") and the trademarks, service marks and logos contained therein (\"Marks\"), are owned by or licensed to Crumblez, subject to copyright and other intellectual property rights under United States and foreign laws and international conventions. Content on the Websites and Applications is provided to you AS IS for your information and personal use only and may not be used, copied, reproduced, distributed, transmitted, broadcast, displayed, sold, licensed, or otherwise exploited for any other purposes whatsoever without the prior written consent of the respective owners. Crumblez reserves all rights not expressly granted in and to the Websites, Applications and the Content. You agree to not engage in the use, copying, or distribution of any of the Content other than expressly permitted herein, including any use, copying, or distribution of User Submissions of third parties obtained through the Websites or Applications for any commercial purposes. If you download or print a copy of the Content for personal use, you must retain all copyright and other proprietary notices contained therein. You agree not to circumvent, disable or otherwise interfere with security related features of the Websites and Applications or features that prevent or restrict use or copying of any Content or enforce limitations on use of the Websites and Applications or the Content therein."}
                    </p>
                    <h2 id="user-submissions" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"User Submissions"}
                    </h2>
                    <ol start="1" className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1 sh-list-decimal sh-space-y-small sh-ml-regular sh-pl-regular">
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"The Websites or Applications may now or in the future permit the submission of photos, audio files, videos or other communications submitted by you and other users (\"User Submissions\") and the hosting, sharing, and/or publishing of such User Submissions. You understand that whether or not such User Submissions are published, Crumblez does not guarantee any confidentiality with respect to any submissions. You agree that Crumblez may publish your name and User Submission on the Websites, Applications or in other press releases or media items."}
                        </p>
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"You shall be solely responsible for your own User Submissions and the consequences of posting or publishing them. In connection with User Submissions, you affirm, represent, and/or warrant that: (i) you own or have the necessary licenses, rights, consents, and permissions to use and authorize Crumblez to use all patent, trademark, trade secret, copyright or other proprietary rights in and to any and all User Submissions to enable inclusion and use of the User Submissions in the manner contemplated by the Websites, Applications and these Terms of Use; and (ii) you have the written consent, release, and/or permission of each and every identifiable individual person in the User Submission to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of the User Submissions in the manner contemplated by the Websites, Applications and these Terms of Use. User agrees that any BFD name registrations become the property of Crumblez IP Holder LLC and Crumblez may use such submissions in any manner in the sole discretion of Crumblez. For clarity, you retain all of your ownership rights in your other User Submissions. However, by submitting the User Submissions to Crumblez, you hereby grant Crumblez a perpetual worldwide, non-exclusive, royalty-free, sublicenseable and transferable license to use, reproduce, distribute, prepare derivative works of, display, and perform the User Submissions in connection with the Websites, Applications and the Crumblez (and its successor's) business, including without limitation for promoting and redistributing part or all of the Websites or Applications (and derivative works thereof) in any media formats and through any media channels. You also hereby grant each recipient of any User Submission a non-exclusive license to access your User Submissions through the Website or Applications, and to use, reproduce, distribute, prepare derivative works of, display and perform such User Submissions as permitted through the functionality of the Websites, Applications and under these Terms of Use."}
                        </p>
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"In connection with User Submissions, you further agree that you will not: (i) submit material that is copyrighted, protected by trade secret or otherwise subject to third party proprietary rights, including privacy and publicity rights, unless you are the owner of such rights or have permission from their rightful owner to post the material and to grant Crumblez all of the license rights granted herein; (ii) publish falsehoods or misrepresentations that could damage Crumblez or any third party; (iii) submit material that is unlawful, obscene, defamatory, libelous, threatening, pornographic, harassing, hateful, racially or ethnically offensive, or encourages conduct that would be considered a criminal offense, give rise to civil liability, violate any law, or is otherwise inappropriate; (iv) post advertisements or solicitations of business: (v) impersonate another person. Crumblez does not endorse any User Submission or any opinion, recommendation, or advice expressed therein, and Crumblez expressly disclaims any and all liability in connection with User Submissions. Crumblez does not permit copyright infringing activities and infringement of intellectual property rights on its Websites or Applications, and Crumblez will block and remove all Content and User Submissions if properly notified that such Content or User Submission infringes on another's intellectual property rights. Crumblez reserves the right to remove Content and User Submissions without prior notice. Crumblez will also terminate a User's access to its Websites or Applications, if they are determined to be a repeat infringer. A repeat infringer is a User who has been notified of infringing activity twice and/or has had a User Submission removed from the Websites or Applications. Crumblez also reserves the right to decide whether Content or a User Submission is appropriate and complies with these Terms of Use for violations other than copyright infringement and violations of intellectual property law, such as, but not limited to, pornography, obscene or defamatory material, or excessive length. Crumblez may remove such User Submissions and/or terminate a User's access for uploading such material in violation of these Terms of Use at any time, without prior notice and at its sole discretion. In addition, you agree that you will not email any of your User Submissions or links to your User Submissions to individuals with whom you are not acquainted."}
                        </p>
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                        ...
                        <ol start="1" className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1 sh-list-decimal sh-space-y-small sh-ml-regular sh-pl-regular">
                          ...
                          <li className="sh-text-ui-dark-cool sh-typo-body-1">
                            {"A statement that the information in the notification is accurate, and under penalty of perjury, that you are authorized to act on behalf of the owner of an exclusive right that is allegedly infringed. Crumblez designated recipient for notifications of claimed infringement is: Copyright Agent, Legal Department, 30 Frank Lloyd Wright Drive, Ann Arbor, MI 48106, email: IP@dominos.com, fax: 734-327-8877. For clarity, only DMCA notices should go to the Copyright Agent; any other feedback, comments, requests for technical support, and other communications should be directed to Crumblez customer service. You acknowledge that if you fail to comply with all of the requirements of this Section 5(D), your DMCA notice may not be valid."}
                          </li>
                        </ol>
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                          {"You understand that when using the Websites and Applications, you may be exposed to User Submissions from a variety of sources, and that Crumblez is not responsible for the accuracy, usefulness, safety, or intellectual property rights of or relating to such User Submissions. You further understand and acknowledge that you may be exposed to User Submissions that are inaccurate, offensive, indecent, or objectionable, and you agree to waive, and hereby do waive, any legal or equitable rights or remedies you have or may have against Crumblez with respect thereto, and agree to indemnify and hold Crumblez, its Owners/Operators, affiliates, and/or licensors, harmless to the fullest extent allowed by law regarding all matters related to your use of the site."}
                        </p>
                      </li>
                    </ol>
                    <h2 id="warranty-disclaimer" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Warranty Disclaimer"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"YOU AGREE THAT YOUR USE OF THE WEBSITES AND APPLICATIONS SHALL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, CRUMBLEZ'S, ITS OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE WEBSITES, APPLICATIONS AND YOUR USE THEREOF. CRUMBLEZ'S MAKES NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE WEBSITES' AND APPLICATIONS' CONTENT OR THE CONTENT OF ANY SITES LINKED TO THE WEBSITES OR APPLICATIONS AND ASSUMES NO LIABILITY OR RESPONSIBILITY FOR ANY (I) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT, (II) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF OUR WEBSITES AND APPLICATIONS, (III) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (IV) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM OUR WEBSITES OR APPLICATIONS, (IV) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH OUR WEBSITES AND APPLICATIONS BY ANY THIRD PARTY, AND/OR (V) ANY ERRORS OR OMISSIONS IN ANY CONTENT OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE WEBSITES AND APPLICATIONS. CRUMBLEZ'S DOES NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE WEBSITES OR APPLICATIONS OR ANY HYPERLINKED WEBSITE OR FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND CRUMBLEZ'S WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE."}
                    </p>
                    <h2 id="limitation-of-liability" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Limitation of Liability"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"IN NO EVENT SHALL CRUMBLEZ'S, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES WHATSOEVER RESULTING FROM ANY (I) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT, (II) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF OUR WEBSITES OR APPLICATIONS, (III) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (IV) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM OUR WEBSITES OR APPLICATIONS, (IV) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE, WHICH MAY BE TRANSMITTED TO OR THROUGH OUR WEBSITES OR APPLICATIONS BY ANY THIRD PARTY, AND/OR (V) ANY ERRORS OR OMISSIONS IN ANY CONTENT OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF YOUR USE OF ANY CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE WEBSITES OR APPLICATIONS, WHETHER BASED ON WARRANTY, CONTRACT, TORT, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT THE COMPANY IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW IN THE APPLICABLE JURISDICTION."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"YOU SPECIFICALLY ACKNOWLEDGE THAT CRUMBLEZ'S SHALL NOT BE LIABLE FOR USER SUBMISSIONS OR THE DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY AND THAT THE RISK OF HARM OR DAMAGE FROM THE FOREGOING RESTS ENTIRELY WITH YOU."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"The Websites and Applications are controlled and offered by Crumblez from its facilities in the United States of America. Crumblez makes no representations that the Websites and Applications are appropriate or available for use in other locations. Those who access or use the Websites and Applications from other jurisdictions do so at their own volition and are responsible for compliance with local law."}
                    </p>
                    <h2 id="indemnity" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Indemnity"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"You agree to defend, indemnify and hold harmless Crumblez, its parent corporations, affiliates officers, directors, employees and agents, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from: (i) your use of and access to the Websites and Applications; (ii) your violation of any term of these Terms of Use; (iii) your violation of any third party right, including without limitation any copyright, property, or privacy right; or (iv) any claim that one of your User Submissions caused damage to a third party. This defense and indemnification obligation will survive these Terms of Use and your use of the Websites and Applications."}
                    </p>
                    <h2 id="ability-to-accept-terms-of-service" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                    ...
                    <h2 id="assignment" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Assignment"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"These Terms of Use, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by Crumblez without restriction."}
                    </p>
                    <h2 id="dominos-pizza-intellectual-property" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Crumblez Intellectual Property"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"This Websites and Applications contain many valuable trademarks owned and used by Crumblez LLC, and its subsidiaries and affiliates throughout the world. These trademarks are used to distinguish Crumblez's quality products and services. These trademarks and related proprietary property are protected from reproduction and simulation under national and international laws and are not to be copied without the express written permission of Crumblez LLC."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"The text, graphics and html code contained in the Websites and Applications are the exclusive property of Crumblez LLC. Except where otherwise noted, the text, graphics and html code contained here may not be copied, distributed, displayed, reproduced or transmitted in any form or by any means without the prior written permission of Crumblez LLC."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"The Websites and Applications may link to sites not maintained by or related to Crumblez. Hyper-text links are provided as a service to users and are not sponsored by or affiliated with the Websites, Applications or Crumblez. Crumblez has not reviewed the sites hyper-linked to or from the Websites and Applications and is not responsible for the content of any other site. These links are to be accessed at the user's own risk. Crumblez makes no representations or warranties about the content, completeness, or accuracy of these links or the sites hyper-linked to the Websites or Applications. Furthermore, Crumblez does not implicitly endorse third-party sites hyper-linked to the Websites or Applications."}
                    </p>
                    <h2 id="dominos-tracker" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Crumblez Tracker®"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"In addition to the Terms of Use, the following additional terms and conditions govern the access and use of the Websites and Applications Crumblez Tracker (\"Crumblez Tracker\") service to request order progress and tracking information (\"Crumblez Tracker Data\") on your Crumblez order. Crumblez authorizes you to request Crumblez Tracker Data for a Crumblez order for which you are the recipient and for no other purpose. You are not authorized to make the Crumblez Tracker Data available on any website or to otherwise use or sell the Crumblez Tracker Data for any other use without the express consent of Crumblez. You acknowledge and agree that the Crumblez Tracker Data are the private property of Crumblez, are provided to you free of charge and that any use of Crumblez Tracker Data is at your sole risk. Crumblez Tracker Data is provided \"AS IS\" and Crumblez disclaims all warranties, express or implied. In addition, any comment or input from you on Crumblez Tracker messaging services that is unlawful, obscene, defamatory, libelous, threatening, pornographic, harassing, hateful, racially or ethnically offensive, or encourages conduct that would be considered a criminal offense, give rise to civil liability, violate any law, or is otherwise inappropriate or in violation of the Terms of Use is prohibited. Any access or use that is inconsistent with these terms is unauthorized and strictly prohibited."}
                    </p>
                    <h2 id="sms" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"SMS"}
                    </h2>
                    <ol start="1" className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1 sh-list-decimal sh-space-y-small sh-ml-regular sh-pl-regular">
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"Your carrier's standard messaging rates apply to your entry or submission message, our confirmation and all subsequent SMS correspondence. Crumblez does not charge for any content however downloadable content may incur additional charges from your cell phone provider. Please contact your wireless carrier for information about your messaging plan. Your carrier may impose message or charge limitations on your account that are outside our control. All charges are billed by and payable to your mobile service provider"}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"By subscribing to marketing messages on shortcode 366466, you consent to receiving up to 6 SMS messages per month using automated technology. Messages from shortcode 366466 may include offers from us, our affiliates and partners. You can unsubscribe at any time from all messages on this shortcode by sending STOP to 366466. Your consent to receive text messages on this shortcode is not required to make a purchase."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"By linking your Crumblez Profile to your mobile number you may choose to place orders by SMS on shortcode 88607. By doing so, you consent to receiving one or more messages in reply from us using automated technology for any messages you send to shortcode 88607 as part of your ordering experience. You can unsubscribe at any time from all ordering messages on this shortcode by sending STOP to 88607."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"By subscribing to order tracking messages on shortcode 88607, you consent to receiving up to 12 SMS messages per order using automated technology. You also consent to receive messages in reply from us for any messages you may send to us on shortcode 88607. You can unsubscribe at any time from all tracking messages on this shortcode by sending STOP to 88607. Message and data rates may apply."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                      ...
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"If you have any questions, email us here. You can also text the word HELP or INFO to 366466 or 88607 to get additional information about these services. We do not charge for help or info messages; however, your normal carrier rates apply."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"Supported Carriers: AT&T, Verizon Wireless, Sprint, T-Mobile USA, Aio Wireless, Alaska Communications Systems (ACS), Appalachian Wireless (EKN), Bluegrass Cellular, Boost Mobile, Carolina West Wireless, CellCom, Cellular One of East Central IL (ECIT), Cellular One of Northeast Arizona, Cellular One of Northeast Pennsylvania, Chariton Valley Cellular, Cricket, Coral Wireless (Mobi PCS), Cross, C-Spire (CellSouth), Duet IP (Maximum Communications New Core Wireless), Element Mobile (Flat Wireless), Epic Touch (Elkhart Telephone), GCI, Golden State, Google Voice, Hawkeye (Chat Mobility), Hawkeye (NW Missouri), Illinois Valley Cellular, Inland Cellular, iWireless (Iowa Wireless), Keystone Wireless (Immix Wireless/PC Man), Metro PCS, Mosaic (Consolidated or CTC Telecom), MTA Communications, MTPCS (Cellular One Nation), Nex-Tech Wireless, Panhandle Communications, Peoples Wireless, Pine Cellular, Pioneer, RINA, Sagebrush Cellular (Nemont), SI Wireless/Mobile Nation, Simmetry (TMP Corporation), SouthernLinc, SRT Wireless, Thumb Cellular, Union Wireless, United Wireless, U.S. Cellular, Viaero Wireless, Virgin Mobile, and West Central (WCC or 5 Star Wireless)."}
                      </li>
                    </ol>
                    <h2 id="voice-ordering-in-mobile-apps" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Voice Ordering in Mobile Apps"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"For iOS and Android Device Users Utilizing the Crumblez Voice Order Feature on the Mobile Application: Your use of Crumblez Voice Ordering platform is optional. When you speak to Dom on Crumblez Voice Ordering platform the things you say will be recorded and sent to Crumblez third party provider, Nuance Communications, to process your requests. The voice input data collected and recorded is used to help Dom to better recognize what you say."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Voice input data collected by Crumblez will be treated in accordance with Crumblez Privacy Policy, which can be found at "}
                      <Link href="/content/privacy" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"https://www.dominos.com/content/privacy"}
                      </Link>
                      {"."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Voice input data that has been collected from you may be retained for a period of time to generally improve Dom, the Voice Ordering platform and voice functionality in other Crumblez products and services. This voice input data may include audio files and transcripts of what you said, and related diagnostic data, such as hardware and operating system specifications and performance statistics."}
                    </p>
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      <strong className="sh-font-semibold sh-text-ui-extra-dark-cool">
                        {"BECAUSE OF THE MUTUAL BENEFITS (SUCH AS REDUCED EXPENSE AND INCREASED EFFICIENCY) WHICH PRIVATE BINDING ARBITRATION CAN PROVIDE, BOTH YOU AND CRUMBLEZ’S PIZZA AGREE THAT ANY CLAIM, DISPUTE, AND/OR CONTROVERSY ARISING OUT OF OR RELATING IN ANY WAY TO YOUR USE OF THE WEB SITES OR THE APPLICATIONS, ANY PRODUCTS SOLD BY CRUMBLEZ’S PIZZA THROUGH THE WEBSITES OR THE APPLICATIONS, THESE TERMS OF USE, OR THE SCOPE OR VALIDITY OF THIS ARBITRATION AGREEMENT SHALL BE SUBMITTED TO AND RESOLVED EXCLUSIVELY BY BINDING ARBITRATION, RATHER THAN IN COURT, EXCEPT THAT YOU MAY ASSERT CLAIMS IN SMALL CLAIMS COURT IF YOUR CLAIMS QUALIFY. ALL MATTERS RELATING TO ARBITRATION WILL BE GOVERNED BY THE FEDERAL ARBITRATION ACT, 9 U.S.C. SECTIONS 1‐16, AND NOT BY ANY STATE ARBITRATION LAW."}
                      </strong>
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Any arbitration pursuant to the Privacy Policy or Terms of Use shall be initiated with and conducted by the American Arbitration Association (AAA) in accordance with the AAA's Consumer Arbitration Rules and Supplementary Procedures for Consumer-Related Disputes, both of which may be obtained at "}
                      <a href="http://www.adr.org/" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"http://www.adr.org"}
                      </a>
                      {" or by calling (800)778‐7879. Payment of all filing, administration and arbitrator fees will be governed by the AAA's rules. You may choose to have the arbitration conducted by telephone, based on written submissions, or in person in Washtenaw County, Michigan. Nothing herein shall prevent Crumblez or you from obtaining from a temporary restraining order or preliminary injunctive relief to preserve the status quo or to prevent any irreparable harm pending the arbitration of the underlying claim, dispute, and/or controversy."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"The arbitration proceedings shall be conducted by a single arbitrator. In addition to any requirements imposed by law, the arbitrator shall be a retired state or federal court judge, or a licensed attorney with arbitration experience and at least ten years’ experience as a lawyer, and shall be subject to disqualification on the same grounds as would apply to a judge of a court in the relevant jurisdiction. The arbitrator shall follow controlling law and issue a decision in writing within 45 days of the arbitration hearing with a supporting opinion based on applicable law. The decision of the arbitrator (the “Decision”) shall be final, binding, and conclusive on the parties and may be entered in any court of competent jurisdiction; provided, however, that You and Crumblez agree that the Decision may be appealed pursuant to the AAA’s Optional Appellate Arbitration Rules (“Appellate Rules”), which may be obtained at "}
                      <a href="http://www.adr.org/" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"http://www.adr.org"}
                      </a>
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      <strong className="sh-font-semibold sh-text-ui-extra-dark-cool">
                        {"WE EACH AGREE THAT ANY DISPUTE RESOLUTION PROCEEDINGS WILL BE CONDUCTED ONLY ON AN INDIVIDUAL BASIS, AND NOT ON A CLASS-WIDE, COLLECTIVE, MULTIPLE‐PARTY, OR PRIVATE ATTORNEY GENERAL BASIS. WE ALSO AGREE THAT ANY ARBITRATION PROCEEDING BETWEEN US MAY NOT BE CONSOLIDATED WITH ANY OTHER ARBITRATION BETWEEN CRUMBLEZ’S AND ANY OTHER PERSON. YOU AND CRUMBLEZ’S PIZZA BOTH UNDERSTAND THAT BY AGREEING TO THIS BINDING ARBITRATION PROVISION, BOTH ARE GIVING UP THEIR RIGHT TO TRIAL BY JURY OF ANY INDIVIDUAL, CLASS-WIDE, COLLECTIVE, MULTIPLE‐PARTY, PRIVATE ATTORNEY GENERAL, OR OTHER CLAIM EITHER MAY HAVE AGAINST THE OTHER, EXCEPT AS EXPRESSLY PROVIDED HEREIN."}
                      </strong>
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Should any term or provision or portion of this arbitration agreement be declared void or unenforceable or deemed in contravention of law, it shall be severed and/or modified and the remainder of this agreement shall be enforceable; provided, however, that if the provision above prohibiting class-wide, collective action, consolidated, or other group arbitration is deemed invalid, then this entire arbitration provision shall be null and void and shall not apply to that dispute, which shall be resolved in a judicial proceeding in Washtenaw County, Michigan."}
                    </p>
                    <h2 id="general" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"General"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"You agree that: (i) the Websites and Applications shall be deemed solely based in Michigan; and (ii) the Websites and Applications shall be deemed passive websites and applications that do not give rise to personal jurisdiction over Crumblez, either specific or general, in jurisdictions other than Michigan. These Terms of Use shall be governed by the internal substantive laws of the State of Michigan, without respect to its conflict of laws principles. These Terms of Use, together with the Privacy Policy and any other legal notices published by Crumblez on the Websites or Applications, shall constitute the entire agreement between you and Crumblez concerning the Websites and Applications. If any provision of these Terms of Use is deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of these Terms of Use, which shall remain in full force and effect. No waiver of any term of this these Terms of Use shall be deemed a further or continuing waiver of such term or any other term, and the failure by Crumblez to assert any right or provision under these Terms of Use shall not constitute a waiver of such right or provision. Certain aspects of our mobile Applications are Licensed under one or more of the following United States patents: U.S. Patent No. 10,102,184; U.S. Patent No. 9,892,093; U.S. Patent No. 9,886,421; U.S. Patent No. 9,405,735; U.S. Patent No. 8,522,127. Crumblez reserves the right to amend these Terms of Use (other than the arbitration provision) at any time and without notice, and it is your responsibility to review these Terms of Use for any changes. YOU AND CRUMBLEZ'S AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE WEBSITES AND APPLICATIONS MUST COMMENCE WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES. OTHERWISE, SUCH CAUSE OF ACTION IS PERMANENTLY BARRED."}
                    </p>
                    <h2 id="gift-cards" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Gift Cards"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"For terms of use and privacy policy information on Gift Cards, please "}
                      <Link href="/content/gift-cards" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"click here"}
                      </Link>
                      {"."}
                    </p>
                    <h2 id="biometric-data-policy-for-employees-of-dominos-pizza-llc" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Biometric Data Policy For Employees of Crumblez LLC"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"For Biometric Data Policy For Employees of Crumblez LLC, please "}
                      <Link href="/content/biometric-data-policy" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"click here"}
                      </Link>
                      {"."}
                    </p>
                    <h2 id="california-transparency-in-supply-chains-act" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"California Transparency in Supply Chains Act"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"As a company philosophy, Crumblez, Inc. and its subsidiaries and affiliates (\"Crumblez\") strongly oppose any and all illegal and unethical treatment of individuals, including acts of slavery or human trafficking. Crumblez utilizes a standard agreement that requires its suppliers to comply with all applicable laws, which includes applicable labor laws. Crumblez also provides to its suppliers a Code of Ethics that similarly notifies suppliers of their obligation to comply with all applicable laws and also provides a dedicated avenue for reporting any illegal or unethical behavior. Crumblez conducts periodic assessments of its suppliers and is determining whether to expand this assessment to obtain information about its suppliers' activities related to the California Transparency in Supply Chains Act of 2010. Crumblez is also considering implementing requests for certification from its suppliers and/or audits of its suppliers. At this time, Crumblez does not plan to utilize a third party to perform any verifications or audits. Crumblez also expects to evaluate whether training and/or changes in accountability standards and procedures for its employees and/or contractors are appropriate."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"These Terms of Use were updated as of March 06, 2017"}
                    </p>
                  </div>
                </div>
              </div>
