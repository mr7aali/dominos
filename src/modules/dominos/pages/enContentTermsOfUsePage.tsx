                ...
                <div className="sh-p-regular">
                  <div>
                    ...
                    <h2 id="dominos-pizza-websites-and-applications" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Domino's Pizza Websites and Applications"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"These Terms of Use, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by Domino's without restriction."}
                    </p>
                    <h2 id="dominos-pizza-intellectual-property" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Domino's Pizza Intellectual Property"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"For iOS and Android Device Users Utilizing the Domino’s Voice Order Feature on the Mobile Application: Your use of Domino’s Voice Ordering platform is optional. When you speak to Dom on Domino’s Voice Ordering platform the things you say will be recorded and sent to Domino’s third party provider, Nuance Communications, to process your requests. The voice input data collected and recorded is used to help Dom to better recognize what you say."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Voice input data collected by Domino’s will be treated in accordance with Domino’s Privacy Policy, which can be found at "}
                      <Link href="/content/privacy" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"For Biometric Data Policy For Employees of Domino's Pizza LLC, please "}
                      <Link href="/content/biometric-data-policy" className="sh-text-blue hover:sh-text-dark-blue sh-break-words sh-underline">
                        {"click here"}
                      </Link>
                      {"."}
