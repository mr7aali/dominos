...
export const metadata: Metadata = {
  ...
  "description": "Order your favorite Crumblez 5cheese_mac_cheese online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuPastaS5CHSMAC5cheeseMacCheesePage() {
  return (
    <>
    <div>
