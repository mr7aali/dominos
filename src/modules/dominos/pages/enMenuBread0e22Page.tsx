...
export const metadata: Metadata = {
  "title": "Cheesy Bread & More Near Me | Crumblez",
  "description": "Order your favorite Crumblez cheesy bread & twists online! Sign up for Crumblez email & text offers to get great deals on your next order.",
  "alternates": {
