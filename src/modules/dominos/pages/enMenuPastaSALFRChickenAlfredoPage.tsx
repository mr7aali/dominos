...
export const metadata: Metadata = {
  "title": "Chicken Alfredo Pasta Near Me | Crumblez",
  "description": "Order your favorite Crumblez Chicken Alfredo pasta online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuPastaSALFRChickenAlfredoPage() {
  return (
    <>
    <div>
