...
export const metadata: Metadata = {
  "title": "Honolulu Hawaiian Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez Honolulu Hawaiian pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySPIZUHHonoluluHawaiianPage() {
  return (
    <>
    <div>
