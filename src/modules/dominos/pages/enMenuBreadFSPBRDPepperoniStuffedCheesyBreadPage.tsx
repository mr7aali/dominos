...
export const metadata: Metadata = {
  "title": "Pepperoni Stuffed Cheesy Bread Near Me | Crumblez",
  "description": "Order your favorite Crumblez Pepperoni Stuffed Cheesy Bread online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuBreadFSPBRDPepperoniStuffedCheesyBreadPage() {
  return (
    <>
    <div>
