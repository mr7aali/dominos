...
export const metadata: Metadata = {
  "title": "Boneless Wings Near Me | Crumblez",
  "description": "Order your favorite Crumblez Boneless wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
