...
export const metadata: Metadata = {
  "title": "Garlic Parmesan Wings Near Me | Crumblez",
  "description": "Order your favorite Crumblez Garlic Parmesan wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuWingsSGPRMWINGGarlicParmesanWingsPage() {
  return (
    <>
    <div>
