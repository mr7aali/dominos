...
export const metadata: Metadata = {
  "title": "Pacific Veggie Pizza Near Me | Crumblez",
  "description": "Order your favorite Crumblez Pacific Veggie pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialtySPIZPVPacificVeggiePage() {
  return (
    <>
    <div>
