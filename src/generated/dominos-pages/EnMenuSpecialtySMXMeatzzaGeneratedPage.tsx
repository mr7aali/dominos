...
export const metadata: Metadata = {
  "title": "MeatZZa Near Me | Domino's",
  "description": "Order your favorite Domino's MeatZZa pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_MX/meatzza"
  },
  "robots": "index"
};

export function EnMenuSpecialtySMXMeatzzaGeneratedPage() {
  return (
    <>
    <div id="__next">
