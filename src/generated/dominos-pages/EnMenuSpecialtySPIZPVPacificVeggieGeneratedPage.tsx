...
export const metadata: Metadata = {
  "title": "Pacific Veggie Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Pacific Veggie pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZPV/pacific_veggie"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZPVPacificVeggieGeneratedPage() {
  return (
    <>
    <div id="__next">
