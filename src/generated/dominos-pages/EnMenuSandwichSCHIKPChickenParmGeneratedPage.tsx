...
export const metadata: Metadata = {
  "title": "Chicken Parm Sandwich Near Me | Domino's",
  "description": "Order your favorite Domino's Chicken Parm sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sandwich/S_CHIKP/chicken_parm"
  },
  "robots": "index"
};

export function EnMenuSandwichSCHIKPChickenParmGeneratedPage() {
  return (
    <>
    <div id="__next">
