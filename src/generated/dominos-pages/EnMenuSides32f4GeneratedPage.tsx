...
export const metadata: Metadata = {
  "title": "sides?type=order_carryout%2FF_SIDMAR%2Fmarinara_dipping_cup%2FF_CAESAR%2Fcaesar_dressing%2FF_BBQC%2Fhoney_bbq_dipping_cup%2FF_SIDMAR%2Fmarinara_dipping_cup%2FF_BBQC%2Fhoney_bbq_dipping_cup%2FF_SIDGAR%2Fgarlic_dipping_cup%2FF_BALVIN%2Fbalsamic%2FF_RANCHPK%2Franch_dressing%2FF_RANCHPK%2Franch_dressing%2FF_SIDRAN%2Franch_dipping_cup Near Me",
  "description": "Order your favorite Domino's sides?type=order_carryout%2FF_SIDMAR%2Fmarinara_dipping_cup%2FF_CAESAR%2Fcaesar_dressing%2FF_BBQC%2Fhoney_bbq_dipping_cup%2FF_SIDMAR%2Fmarinara_dipping_cup%2FF_BBQC%2Fhoney_bbq_dipping_cup%2FF_SIDGAR%2Fgarlic_dipping_cup%2FF_BALVIN%2Fbalsamic%2FF_RANCHPK%2Franch_dressing%2FF_RANCHPK%2Franch_dressing%2FF_SIDRAN%2Franch_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides"
  },
  "robots": "index"
};

export function EnMenuSides32f4GeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Slice Sauce Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/c34ac73a-2983-40ae-8caf-29ed9a663aba3f15.png?modified_on=2026-02-04T14%3A57%3A07.015Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Slice Sauce Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/c34ac73a-2983-40ae-8caf-29ed9a663aba3f15.png?modified_on=2026-02-04T14%3A57%3A07.015Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Slice Sauce Dipping Cup-source-md" srcSet="/site-assets/cms/assets/c34ac73a-2983-40ae-8caf-29ed9a663aba3f15.png?modified_on=2026-02-04T14%3A57%3A07.015Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Slice Sauce Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/c34ac73a-2983-40ae-8caf-29ed9a663aba3f15.png?modified_on=2026-02-04T14%3A57%3A07.015Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row justify-between">
                            <div className="self-start lg:m-small">
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Slice Sauce Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                  ...
                                  <button aria-label="Add one Slice Sauce Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"Domino's own spicy buffalo sauce."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Hot Buffalo Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/982ff959-3140-472b-ad10-41f1fd8c672402dd.png?modified_on=2025-11-20T20%3A21%3A33.571Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Hot Buffalo Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/982ff959-3140-472b-ad10-41f1fd8c672402dd.png?modified_on=2025-11-20T20%3A21%3A33.571Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Hot Buffalo Dipping Cup-source-md" srcSet="/site-assets/cms/assets/982ff959-3140-472b-ad10-41f1fd8c672402dd.png?modified_on=2025-11-20T20%3A21%3A33.571Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Hot Buffalo Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/982ff959-3140-472b-ad10-41f1fd8c672402dd.png?modified_on=2025-11-20T20%3A21%3A33.571Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_HOTCUP/hot_buffalo_dipping_cup">
                              {"Customize "}
                              {"Hot Buffalo Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Hot Buffalo Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Hot Buffalo Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Hot Buffalo Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A perfect blend of sweet and spicy in one sauce"}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Sweet Mango Habanero Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/9dece078-a952-4151-94e2-7c831dde923257d2.png?modified_on=2025-11-21T14%3A13%3A16.289Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Sweet Mango Habanero Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/9dece078-a952-4151-94e2-7c831dde923257d2.png?modified_on=2025-11-21T14%3A13%3A16.289Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Sweet Mango Habanero Dipping Cup-source-md" srcSet="/site-assets/cms/assets/9dece078-a952-4151-94e2-7c831dde923257d2.png?modified_on=2025-11-21T14%3A13%3A16.289Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Sweet Mango Habanero Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/9dece078-a952-4151-94e2-7c831dde923257d2.png?modified_on=2025-11-21T14%3A13%3A16.289Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_SMHAB/sweet_mango_habanero_dipping_cup">
                              {"Customize "}
                              {"Sweet Mango Habanero Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Sweet Mango Habanero Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Sweet Mango Habanero Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Sweet Mango Habanero Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A sweet and smoky BBQ sauce with bold flavor."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Honey BBQ Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/6bc602ea-23d8-4c88-bc4d-0da9b4855641f51a.png?modified_on=2025-11-21T14%3A16%3A22.731Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Honey BBQ Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/6bc602ea-23d8-4c88-bc4d-0da9b4855641f51a.png?modified_on=2025-11-21T14%3A16%3A22.731Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Honey BBQ Dipping Cup-source-md" srcSet="/site-assets/cms/assets/6bc602ea-23d8-4c88-bc4d-0da9b4855641f51a.png?modified_on=2025-11-21T14%3A16%3A22.731Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Honey BBQ Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/6bc602ea-23d8-4c88-bc4d-0da9b4855641f51a.png?modified_on=2025-11-21T14%3A16%3A22.731Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_BBQC/honey_bbq_dipping_cup">
                              {"Customize "}
                              {"Honey BBQ Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Honey BBQ Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Honey BBQ Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Honey BBQ Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Ranch Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/1722ee7c-788f-4cef-867f-5195d7bc7d75ab06.png?modified_on=2025-11-21T16%3A20%3A37.361Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Ranch Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/1722ee7c-788f-4cef-867f-5195d7bc7d75ab06.png?modified_on=2025-11-21T16%3A20%3A37.361Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Ranch Dipping Cup-source-md" srcSet="/site-assets/cms/assets/1722ee7c-788f-4cef-867f-5195d7bc7d75ab06.png?modified_on=2025-11-21T16%3A20%3A37.361Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Ranch Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/1722ee7c-788f-4cef-867f-5195d7bc7d75ab06.png?modified_on=2025-11-21T16%3A20%3A37.361Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_SIDRAN/ranch_dipping_cup">
                              {"Customize "}
                              {"Ranch Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Ranch Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Ranch Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Ranch Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A creamy dressing with bits of aged blue cheese"}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Blue Cheese Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/25ca46f9-a1db-4342-8a22-2d61d3b2cbd5380b.png?modified_on=2025-11-21T14%3A19%3A21.675Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Blue Cheese Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/25ca46f9-a1db-4342-8a22-2d61d3b2cbd5380b.png?modified_on=2025-11-21T14%3A19%3A21.675Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Blue Cheese Dipping Cup-source-md" srcSet="/site-assets/cms/assets/25ca46f9-a1db-4342-8a22-2d61d3b2cbd5380b.png?modified_on=2025-11-21T14%3A19%3A21.675Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Blue Cheese Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/25ca46f9-a1db-4342-8a22-2d61d3b2cbd5380b.png?modified_on=2025-11-21T14%3A19%3A21.675Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_Bd/blue_cheese_dipping_cup">
                              {"Customize "}
                              {"Blue Cheese Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Blue Cheese Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Blue Cheese Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Blue Cheese Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Garlic Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/a09de470-f2ea-44c3-803a-c53c941c94c06010.png?modified_on=2025-11-21T14%3A27%3A11.658Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Garlic Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/a09de470-f2ea-44c3-803a-c53c941c94c06010.png?modified_on=2025-11-21T14%3A27%3A11.658Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Garlic Dipping Cup-source-md" srcSet="/site-assets/cms/assets/a09de470-f2ea-44c3-803a-c53c941c94c06010.png?modified_on=2025-11-21T14%3A27%3A11.658Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Garlic Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/a09de470-f2ea-44c3-803a-c53c941c94c06010.png?modified_on=2025-11-21T14%3A27%3A11.658Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_SIDGAR/garlic_dipping_cup">
                              {"Customize "}
                              {"Garlic Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Garlic Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Garlic Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Garlic Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Icing Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/1e0a6fbe-4827-446c-9ebd-5c3d90a45d458d0a.png?modified_on=2025-11-21T14%3A28%3A24.574Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Icing Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/1e0a6fbe-4827-446c-9ebd-5c3d90a45d458d0a.png?modified_on=2025-11-21T14%3A28%3A24.574Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Icing Dipping Cup-source-md" srcSet="/site-assets/cms/assets/1e0a6fbe-4827-446c-9ebd-5c3d90a45d458d0a.png?modified_on=2025-11-21T14%3A28%3A24.574Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Icing Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/1e0a6fbe-4827-446c-9ebd-5c3d90a45d458d0a.png?modified_on=2025-11-21T14%3A28%3A24.574Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_SIDICE/icing_dipping_cup">
                              {"Customize "}
                              {"Icing Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Icing Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Icing Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Icing Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A sweet tomato sauce blended with garlic, basil and oregano"}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Marinara Dipping Cup-source-xl" srcSet="/site-assets/cms/assets/dacbc263-d458-4a23-ad21-44a45e2d2baf933c.png?modified_on=2025-11-21T14%3A29%3A32.574Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Marinara Dipping Cup-source-lg" srcSet="/site-assets/cms/assets/dacbc263-d458-4a23-ad21-44a45e2d2baf933c.png?modified_on=2025-11-21T14%3A29%3A32.574Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Marinara Dipping Cup-source-md" srcSet="/site-assets/cms/assets/dacbc263-d458-4a23-ad21-44a45e2d2baf933c.png?modified_on=2025-11-21T14%3A29%3A32.574Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Marinara Dipping Cup-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/dacbc263-d458-4a23-ad21-44a45e2d2baf933c.png?modified_on=2025-11-21T14%3A29%3A32.574Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_SIDMAR/marinara_dipping_cup">
                              {"Customize "}
                              {"Marinara Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Marinara Dipping Cup to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Marinara Dipping Cup" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Marinara Dipping Cup" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A savory dressing with a combination of garlic, anchovy and subtle notes of cheese. Dressing brand may vary by location."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Caesar Dressing-source-xl" srcSet="/site-assets/cms/assets/baca7f6c-0a5e-4b4e-9189-51ea35cb0c062c00.png?modified_on=2025-11-21T20%3A52%3A05.570Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Caesar Dressing-source-lg" srcSet="/site-assets/cms/assets/baca7f6c-0a5e-4b4e-9189-51ea35cb0c062c00.png?modified_on=2025-11-21T20%3A52%3A05.570Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Caesar Dressing-source-md" srcSet="/site-assets/cms/assets/baca7f6c-0a5e-4b4e-9189-51ea35cb0c062c00.png?modified_on=2025-11-21T20%3A52%3A05.570Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Caesar Dressing-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/baca7f6c-0a5e-4b4e-9189-51ea35cb0c062c00.png?modified_on=2025-11-21T20%3A52%3A05.570Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_CAESAR/caesar_dressing">
                              {"Customize "}
                              {"Caesar Dressing"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Caesar Dressing to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Caesar Dressing" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Caesar Dressing" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A creamy, flavorful dressing with a blend of buttermilk, garlic, onion and spices. Dressing brand may vary by location."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Ranch Dressing-source-xl" srcSet="/site-assets/cms/assets/1aafa24c-eb75-4afb-84f4-5856938ab7507579.png?modified_on=2025-11-21T20%3A49%3A58.874Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Ranch Dressing-source-lg" srcSet="/site-assets/cms/assets/1aafa24c-eb75-4afb-84f4-5856938ab7507579.png?modified_on=2025-11-21T20%3A49%3A58.874Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Ranch Dressing-source-md" srcSet="/site-assets/cms/assets/1aafa24c-eb75-4afb-84f4-5856938ab7507579.png?modified_on=2025-11-21T20%3A49%3A58.874Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Ranch Dressing-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/1aafa24c-eb75-4afb-84f4-5856938ab7507579.png?modified_on=2025-11-21T20%3A49%3A58.874Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_RANCHPK/ranch_dressing">
                              {"Customize "}
                              {"Ranch Dressing"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Ranch Dressing to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Ranch Dressing" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Ranch Dressing" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="St. Jude Donation-source-xl" srcSet="/site-assets/cms/assets/f5f0f552-8683-4d92-b0c7-f2bdefa57c387472.jpg?modified_on=2024-02-11T03%3A04%3A45.568Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="St. Jude Donation-source-lg" srcSet="/site-assets/cms/assets/f5f0f552-8683-4d92-b0c7-f2bdefa57c387472.jpg?modified_on=2024-02-11T03%3A04%3A45.568Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="St. Jude Donation-source-md" srcSet="/site-assets/cms/assets/f5f0f552-8683-4d92-b0c7-f2bdefa57c387472.jpg?modified_on=2024-02-11T03%3A04%3A45.568Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="St. Jude Donation-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/f5f0f552-8683-4d92-b0c7-f2bdefa57c387472.jpg?modified_on=2024-02-11T03%3A04%3A45.568Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_STJUDE/st_jude_donation">
                              {"Customize "}
                              {"St. Jude Donation"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add St. Jude Donation to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one St. Jude Donation" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one St. Jude Donation" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"A light dressing with a blend of balsamic vinegar, oil and garlic. Dressing brand may vary by location."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Balsamic-source-xl" srcSet="/site-assets/cms/assets/9a2a451a-ab9b-480f-b97b-613473a3d64f70e2.png?modified_on=2025-11-21T20%3A49%3A24.418Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Balsamic-source-lg" srcSet="/site-assets/cms/assets/9a2a451a-ab9b-480f-b97b-613473a3d64f70e2.png?modified_on=2025-11-21T20%3A49%3A24.418Z&im=Resize%3D%28431%2C431%29%3BCrop%2Crect%3D%280%2C0%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Balsamic-source-md" srcSet="/site-assets/cms/assets/9a2a451a-ab9b-480f-b97b-613473a3d64f70e2.png?modified_on=2025-11-21T20%3A49%3A24.418Z&im=Resize%3D%28230%2C230%29%3BCrop%2Crect%3D%280%2C0%2C230%2C230%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Balsamic-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/9a2a451a-ab9b-480f-b97b-613473a3d64f70e2.png?modified_on=2025-11-21T20%3A49%3A24.418Z&im=Resize%3D%28234%2C234%29%3BCrop%2Crect%3D%280%2C0%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sides/F_BALVIN/balsamic">
                              {"Customize "}
                              {"Balsamic"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Balsamic to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Balsamic" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Balsamic" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                    ...
                    <ul className="pd-grid pd-auto-cols-fr pd-auto-rows-fr pd-grid-cols-2 pd-gap-regular md:pd-grid-cols-4 lg:pd-grid-cols-6">
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/build-your-own">
                              {"Build Your Own"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/specialty">
                              {"Specialty Pizzas"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/bread">
                              {"Breads"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/wings">
                              {"Chicken"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/dessert">
                              {"Desserts"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/pasta">
                              {"Oven-Baked Pastas"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/sandwich">
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/g-salad">
                              {"Salads"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/drinks">
                              {"Drinks"}
                            </Link>
                          </div>
                        </div>
                      ...
                      <li className="">
                        <div className="clickable-card flex h-full flex-col overflow-hidden rounded-lg text-ui-extra-dark-cool outline-dark-blue bg-cool-gray-200 hover:border-ui-medium-cool focus:outline-2 active:outline-blue hover:outline hover:outline-1 hover:outline-cool-gray-700 active:outline-2 active:hover:outline-2 aspect-square active:outline active:outline-blue" data-testid="clickable-card">
                          ...
                          <div className="z-[5] bg-cool-gray-200 bg-opacity-70">
                            <Link className="text-left flex items-end justify-start outline-none typo-label-2 mx-regular mb-small lg:typo-label-1 lg:mx-medium lg:mb-medium z-10" href="/en/menu/sides">
                              {"Extras"}
                            </Link>
                          </div>
                        </div>
