...
export const metadata: Metadata = {
  "title": "sides?type=order_carryout%2FF_SIDGAR%2Fgarlic_dipping_cup%2FF_RANCHPK%2Franch_dressing%2FF_CAESAR%2Fcaesar_dressing%2FF_RANCHPK%2Franch_dressing%2FF_SIDGAR%2Fgarlic_dipping_cup%2FF_STJUDE%2Fst_jude_donation%2FF_SMHAB%2Fsweet_mango_habanero_dipping_cup%2FF_BBQC%2Fhoney_bbq_dipping_cup Near Me",
  "description": "Order your favorite Domino's sides?type=order_carryout%2FF_SIDGAR%2Fgarlic_dipping_cup%2FF_RANCHPK%2Franch_dressing%2FF_CAESAR%2Fcaesar_dressing%2FF_RANCHPK%2Franch_dressing%2FF_SIDGAR%2Fgarlic_dipping_cup%2FF_STJUDE%2Fst_jude_donation%2FF_SMHAB%2Fsweet_mango_habanero_dipping_cup%2FF_BBQC%2Fhoney_bbq_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function MenuSides32f4GeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row justify-between">
                            ...
                            <Link className="sr-only" href="/menu/sides/F_SIDSLICE/slice_sauce_dipping_cup">
                              {"Customize "}
                              {"Slice Sauce Dipping Cup"}
                            </Link>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_HOTCUP/hot_buffalo_dipping_cup">
                              {"Customize "}
                              {"Hot Buffalo Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_SMHAB/sweet_mango_habanero_dipping_cup">
                              {"Customize "}
                              {"Sweet Mango Habanero Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_BBQC/honey_bbq_dipping_cup">
                              {"Customize "}
                              {"Honey BBQ Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_SIDRAN/ranch_dipping_cup">
                              {"Customize "}
                              {"Ranch Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_Bd/blue_cheese_dipping_cup">
                              {"Customize "}
                              {"Blue Cheese Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_SIDGAR/garlic_dipping_cup">
                              {"Customize "}
                              {"Garlic Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_SIDICE/icing_dipping_cup">
                              {"Customize "}
                              {"Icing Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_SIDMAR/marinara_dipping_cup">
                              {"Customize "}
                              {"Marinara Dipping Cup"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_CAESAR/caesar_dressing">
                              {"Customize "}
                              {"Caesar Dressing"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_RANCHPK/ranch_dressing">
                              {"Customize "}
                              {"Ranch Dressing"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_STJUDE/st_jude_donation">
                              {"Customize "}
                              {"St. Jude Donation"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sides/F_BALVIN/balsamic">
                              {"Customize "}
                              {"Balsamic"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
