...
export const metadata: Metadata = {
  "title": "icing_dipping_cup Near Me",
  "description": "Order your favorite Domino's icing_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_SIDICE/icing_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFSIDICEIcingDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
