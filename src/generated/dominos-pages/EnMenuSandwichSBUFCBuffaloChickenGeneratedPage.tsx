...
export const metadata: Metadata = {
  "title": "Buffalo Chicken Sandwich Near Me | Domino's",
  "description": "Order your favorite Domino's Buffalo Chicken sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sandwich/S_BUFC/buffalo_chicken"
  },
  "robots": "index"
};

export function EnMenuSandwichSBUFCBuffaloChickenGeneratedPage() {
  return (
    <>
    <div id="__next">
