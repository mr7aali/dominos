...
export const metadata: Metadata = {
  "title": "Spinach & Feta Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Spinach & Feta pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PISPF/spinach_feta"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPISPFSpinachFetaGeneratedPage() {
  return (
    <>
    <div id="__next">
