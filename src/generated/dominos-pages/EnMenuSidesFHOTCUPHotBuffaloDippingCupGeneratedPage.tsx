...
export const metadata: Metadata = {
  "title": "hot_buffalo_dipping_cup Near Me",
  "description": "Order your favorite Domino's hot_buffalo_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_HOTCUP/hot_buffalo_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFHOTCUPHotBuffaloDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
