...
export const metadata: Metadata = {
  "title": "Garlic Bread Bites Near Me | Domino's",
  "description": "Order your favorite Domino's Garlic Bread Bites online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/bread/F_GBITES/garlic_bread_bites"
  },
  "robots": "index"
};

export function EnMenuBreadFGBITESGarlicBreadBitesGeneratedPage() {
  return (
    <>
    <div id="__next">
