...
export const metadata: Metadata = {
  "title": "Italian Sandwich Near Me | Domino's",
  "description": "Order your favorite Domino's Italian sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sandwich/S_ITALIAN/italian"
  },
  "robots": "index"
};

export function EnMenuSandwichSITALIANItalianGeneratedPage() {
  return (
    <>
    <div id="__next">
