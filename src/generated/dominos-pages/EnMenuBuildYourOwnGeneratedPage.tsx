...
export const metadata: Metadata = {
  "title": "Build Your Own Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's build your own pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
...
export function EnMenuBuildYourOwnGeneratedPage() {
  return (
    <>
    <div id="__next">
