...
export const metadata: Metadata = {
  "title": "Pepperoni Stuffed Cheesy Bread Near Me | Domino's",
  "description": "Order your favorite Domino's Pepperoni Stuffed Cheesy Bread online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/bread/F_SPBRD/pepperoni_stuffed_cheesy_bread"
  },
  "robots": "index"
};

export function EnMenuBreadFSPBRDPepperoniStuffedCheesyBreadGeneratedPage() {
  return (
    <>
    <div id="__next">
