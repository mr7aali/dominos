...
export const metadata: Metadata = {
  "title": "Classic Garden Salad Near Me | Domino's",
  "description": "Order your favorite Domino's Classic Garden salad online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/g-salad/F_GARDEN/classic_garden"
  },
  "robots": "index"
};

export function EnMenuGSaladFGARDENClassicGardenGeneratedPage() {
  return (
    <>
    <div id="__next">
