...
export const metadata: Metadata = {
  "title": "Sweet BBQ Bacon Specialty Chicken | Domino's",
  "description": "Order your favorite Domino's Sweet BBQ Bacon Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_SCSBBQ/loaded_chicken_sweet_bbq_bacon"
  },
  "robots": "index"
};

export function EnMenuWingsSSCSBBQLoadedChickenSweetBbqBaconGeneratedPage() {
  return (
    <>
    <div id="__next">
