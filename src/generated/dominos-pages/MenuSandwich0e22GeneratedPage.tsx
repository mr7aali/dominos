...
export const metadata: Metadata = {
  "title": "sandwich?type=order_carryout Near Me",
  "description": "Order your favorite Domino's sandwich?type=order_carryout online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function MenuSandwich0e22GeneratedPage() {
  return (
    <>
    <div id="__next">
