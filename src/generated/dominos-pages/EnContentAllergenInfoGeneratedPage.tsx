...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical": "/en/content/allergen-info"
  },
  "robots": "index"
};

export function EnContentAllergenInfoGeneratedPage() {
  return (
    <>
    <div id="__next">
              ...
              <div className="flex w-full max-w-screen-xl flex-col gap-xx-large self-center px-medium pb-xx-large pt-x-large md:gap-mega-1 md:px-x-large md:pb-mega-1 lg:gap-mega-1 lg:pb-mega-1 lg:pt-mega-1">
                <div className="sh-p-regular">
                  <div>
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Major allergens associated with our ingredients are summarized in the chart below. If you still have questions, "}
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"X - Contains Allergen; O - Manufactured in a facility that handles peanuts and tree nuts."}
                    </p>
                    <table className="sh-my-large sh-border-cool-gray-600 sh-border-[1px] sh-w-full sh-table-auto sh-overflow-x-auto sh-block lg:sh-table">
                      <thead>
                        <tr>
                          <th className="sh-border-cool-gray-600 sh-border-[1px] sh-p-tiny sh-whitespace-nowrap lg:sh-whitespace-normal">
                            {"Ingredients"}
                          </th>
                      ...
                      <tbody>
                        <tr>
                          <td className="sh-border-cool-gray-600 sh-border-[1px] sh-p-tiny sh-whitespace-nowrap lg:sh-whitespace-normal">
                            {"5-CHEESE MAC & CHEESE"}
                          </td>
                          ...
                          <td style={{ textAlign: "center" }} className="sh-border-cool-gray-600 sh-border-[1px] sh-p-tiny sh-whitespace-nowrap lg:sh-whitespace-normal"></td>
                          <td style={{ textAlign: "center" }} className="sh-border-cool-gray-600 sh-border-[1px] sh-p-tiny sh-whitespace-nowrap lg:sh-whitespace-normal"></td>
                          <td style={{ textAlign: "center" }} className="sh-border-cool-gray-600 sh-border-[1px] sh-p-tiny sh-whitespace-nowrap lg:sh-whitespace-normal"></td>
                          <td style={{ textAlign: "center" }} className="sh-border-cool-gray-600 sh-border-[1px] sh-p-tiny sh-whitespace-nowrap lg:sh-whitespace-normal">
                            {"X"}
