...
export const metadata: Metadata = {
  "title": "Plain Wings Near Me  | Domino's",
  "description": "Order your favorite Domino's Plain wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_PLNWINGS/plain_wings"
  },
  "robots": "index"
};

export function EnMenuWingsSPLNWINGSPlainWingsGeneratedPage() {
  return (
    <>
    <div id="__next">
