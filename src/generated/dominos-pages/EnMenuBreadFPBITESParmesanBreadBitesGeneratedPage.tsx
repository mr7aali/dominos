...
export const metadata: Metadata = {
  "title": "Parmesan Bread Bites Near Me | Domino's",
  "description": "Order your favorite Domino's Parmesan Bread Bites online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/bread/F_PBITES/parmesan_bread_bites"
  },
  "robots": "index"
};

export function EnMenuBreadFPBITESParmesanBreadBitesGeneratedPage() {
  return (
    <>
    <div id="__next">
