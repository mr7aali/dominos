...
export const metadata: Metadata = {
  "title": "Diet Coke Near Me | Domino's",
  "description": "Order your favorite Domino's Diet Coke online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/drinks/F_DIET/diet_coke"
  },
  "robots": "index"
};

export function EnMenuDrinksFDIETDietCokeGeneratedPage() {
  return (
    <>
    <div id="__next">
