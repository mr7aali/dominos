...
export function En32f4GeneratedPage() {
  return (
    <>
    <div id="__next">
              ...
              <div className="m-auto w-full max-w-screen-xl">
                ...
                <div>
                  <div className="sh-grid">
                          ...
                          <div className="sh-flex sh-w-full sh-items-center sh-justify-between sh-rounded-lg sh-bg-cool-gray-200 sh-px-regular sh-py-small">
                            <p className="sh-text-balance sh-text-center sh-text-blue sh-typo-headline-2">
                              ...
                              <span className="sh-hidden md:sh-inline">
                                {"Get Domino's delivered to your door or pick up at a store."}
                              </span>
                            </p>
                    ...
                    <div className="sh-col-start-1 sh-row-start-1">
                      <div className="cp-grid cp-h-full md:cp-min-h-[36rem] lg:cp-hidden cp-min-h-[95vh]" data-testid="tiles-narrow">
                        <div aria-label="Deals" aria-roledescription="carousel" className="relative grid h-full w-full grid-cols-1 grid-rows-1" role="group" data-testid="carousel">
                          <div aria-atomic="false" aria-live="polite" className="relative grid grid-cols-1 grid-rows-1 overflow-hidden">
                            <div aria-label="Deal, 1 of 6" aria-roledescription="slide" className="absolute h-full w-full" role="group">
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                                <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      <source media="(min-width: 1000px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(210,873,2796,837);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(210,873,2796,837);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(min-width: 500px)" sizes="(max-width: 1000px) 100vw, 1000px" srcSet="/site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(672,870,2540,1588);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(672,870,2540,1588);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="100vw" srcSet="/site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(1436,356,1382,2354);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(1436,356,1382,2354);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(1436,356,1382,2354);Resize=(1000),allowExpansion 1000w" />
                                      <img src="/site-assets/cms/assets/3e434123-d667-4f23-960c-d55c9987e1090fb9.jpg?im=Crop,rect=(210,873,2796,837);Resize=(1700),allowExpansion" alt="" loading="eager" className="h-auto w-full rounded-lg object-cover cp-h-full cp-rounded-none xl:cp-rounded-lg" />
                                    </picture>
                                        ...
                                        <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                          <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                            <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                              <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Ril6b5dmf6H1:">
                                              ...
                                              <div className="cp-mt-tiny">
                                                <button type="button" aria-labelledby=":Ril6b5dmf6: :Ril6b5dmf6H1:" data-testid="tile-button-BestDealEver" id=":Ril6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                  {"Add deal"}
                                                </button>
                                              </div>
                                            </div>
                                  ...
                                  <div className="mx-auto">
                                    <div className="text-center text-text-secondary typo-label-5">
                                      <p>
                                        ...
                                        {" "}
                                        <button className="cp-underline" type="button">
                                          {"Offer details."}
                                        </button>
                                      </p>
                                    </div>
                            ...
                            <div aria-label="Deal, 2 of 6" aria-roledescription="slide" className="absolute h-full w-full" role="group" hidden style={{ display: "none" }}>
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                                <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      <source media="(min-width: 1000px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(50,780,3450,1029);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(50,780,3450,1029);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(min-width: 500px)" sizes="(max-width: 1000px) 100vw, 1000px" srcSet="/site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(639,566,2583,1917);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(639,566,2583,1917);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="100vw" srcSet="/site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(1470,530,1300,2207);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(1470,530,1300,2207);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(1470,530,1300,2207);Resize=(1000),allowExpansion 1000w" />
                                      <img src="/site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b6d8ac.jpg?im=Crop,rect=(50,780,3450,1029);Resize=(1700),allowExpansion" alt="Mix and Match" loading="lazy" className="h-auto w-full rounded-lg object-cover cp-h-full cp-rounded-none xl:cp-rounded-lg" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                          <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                            <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                              <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rkl6b5dmf6H1:">
                                                <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                  <span>
                                                    {"Mix and match"}
                                                  </span>
                                              ...
                                              <div className="cp-mt-tiny">
                                                <button type="button" aria-labelledby=":Rkl6b5dmf6: :Rkl6b5dmf6H1:" data-testid="tile-button-MixAndMatch" id=":Rkl6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                  {"Add deal"}
                                                </button>
                                              </div>
                                            </div>
                            ...
                            <div aria-label="Deal, 3 of 6" aria-roledescription="slide" className="absolute h-full w-full" role="group" hidden style={{ display: "none" }}>
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                                <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      <source media="(min-width: 1000px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(0,600,3636,1086);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(0,600,3636,1086);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(min-width: 500px)" sizes="(max-width: 1000px) 100vw, 1000px" srcSet="/site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(374,325,2860,1234);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(374,325,2860,1234);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="100vw" srcSet="/site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(1900,150,1200,2037);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(1900,150,1200,2037);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(1900,150,1200,2037);Resize=(1000),allowExpansion 1000w" />
                                      <img src="/site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e39745.png?im=Crop,rect=(0,600,3636,1086);Resize=(1700),allowExpansion" alt="Weeklong Carryout" loading="lazy" className="h-auto w-full rounded-lg object-cover cp-h-full cp-rounded-none xl:cp-rounded-lg" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                          <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                            <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                              <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rml6b5dmf6H1:">
                                                <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                  <span>
                                                    {"Weeklong carryout"}
                                                  </span>
                                              ...
                                              <div className="cp-mt-tiny">
                                                <button type="button" aria-labelledby=":Rml6b5dmf6: :Rml6b5dmf6H1:" data-testid="tile-button-WeekLongCarryout" id=":Rml6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                  {"Add deal"}
                                                </button>
                                              </div>
                                            </div>
                            ...
                            <div aria-label="Deal, 4 of 6" aria-roledescription="slide" className="absolute h-full w-full" role="group" hidden style={{ display: "none" }}>
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                                <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      <source media="(min-width: 1000px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(null,null,null,null);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(null,null,null,null);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(min-width: 500px)" sizes="(max-width: 1000px) 100vw, 1000px" srcSet="/site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(1030,68,2668,1617);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(1030,68,2668,1617);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="100vw" srcSet="/site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(1368,170,1289,2119);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(1368,170,1289,2119);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(1368,170,1289,2119);Resize=(1000),allowExpansion 1000w" />
                                      <img src="/site-assets/cms/assets/premiumseriesnationaldeal4179.jpg?im=Crop,rect=(null,null,null,null);Resize=(1700),allowExpansion" alt="" loading="lazy" className="h-auto w-full rounded-lg object-cover cp-h-full cp-rounded-none xl:cp-rounded-lg" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                          <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                            <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                              <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rol6b5dmf6H1:">
                                                <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                  <span>
                                              ...
                                              <div className="cp-mt-tiny">
                                                <button type="button" aria-labelledby=":Rol6b5dmf6: :Rol6b5dmf6H1:" data-testid="tile-button-PremiumSeries" id=":Rol6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                  {"Add deal"}
                                                </button>
                                              </div>
                                            </div>
                            ...
                            <div aria-label="Deal, 5 of 6" aria-roledescription="slide" className="absolute h-full w-full" role="group" hidden style={{ display: "none" }}>
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                                <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      <source media="(min-width: 1000px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(30,511,3993,1191);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(30,511,3993,1191);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(min-width: 500px)" sizes="(max-width: 1000px) 100vw, 1000px" srcSet="/site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(801,514,2484,1072);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(801,514,2484,1072);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="100vw" srcSet="/site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(1187,0,1604,2722);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(1187,0,1604,2722);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc40419.jpg?im=Crop,rect=(1187,0,1604,2722);Resize=(1000),allowExpansion 1000w" />
                                      <img src="/site-assets/cms/assets/a42244cb-ee24-4231-b6cf-cfdfbf1f2bc4916c.jpg?im=Crop,rect=(30,511,3993,1191);Resize=(1700),allowExpansion" alt="The perfect combo" loading="lazy" className="h-auto w-full rounded-lg object-cover cp-h-full cp-rounded-none xl:cp-rounded-lg" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                          <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                            <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                              <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rql6b5dmf6H1:">
                                                <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                  <span>
                                                    {"The perfect combo"}
                                                  </span>
                                              ...
                                              <div className="cp-mt-tiny">
                                                <button type="button" aria-labelledby=":Rql6b5dmf6: :Rql6b5dmf6H1:" data-testid="tile-button-PerfectCombo" id=":Rql6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                  {"Add deal"}
                                                </button>
                                              </div>
                                            </div>
                                    ...
                                    <div className="text-center text-text-secondary typo-label-5">
                                      <p>
                                        <span>
                                          ...
                                          {" You must ask for this limited time offer. Delivery charge and tax may apply. Prices, participation, delivery area, and charges may vary. Handmade Pan and Parmesan Stuffed Crust pizzas will be extra. No substitutions permitted. For details on pricing, contact your local store. Pricing for online orders available at checkout."}
                                        </span>
                                        {" "}
                                        <button className="cp-underline" type="button">
                                          {"Offer details"}
                            ...
                            <div aria-label="Deal, 6 of 6" aria-roledescription="slide" className="absolute h-full w-full" role="group" hidden style={{ display: "none" }}>
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                                <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      <source media="(min-width: 1000px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(27,367,1450,432);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(27,367,1450,432);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(min-width: 500px)" sizes="(max-width: 1000px) 100vw, 1000px" srcSet="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(151,105,1200,749);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(151,105,1200,749);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="100vw" srcSet="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(1000),allowExpansion 1000w" />
                                      <img src="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(27,367,1450,432);Resize=(1700),allowExpansion" alt="" loading="lazy" className="h-auto w-full rounded-lg object-cover cp-h-full cp-rounded-none xl:cp-rounded-lg" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                          <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                            <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                              <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rsl6b5dmf6H1:">
                                                <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                  <span>
                                                    {"Local deals"}
                                                  </span>
                                              ...
                                              <div className="cp-mt-tiny">
                                                <button type="button" aria-labelledby=":Rsl6b5dmf6: :Rsl6b5dmf6H1:" data-testid="tile-button-LocalDeals" id=":Rsl6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                  {"See local deals"}
                                                </button>
                                              </div>
                                            </div>
                          ...
                          <div className="absolute left-1/2 -translate-x-1/2 cp-bottom-[7rem]" role="group" aria-roledescription="controls">
                            <div className="inline-flex h-mega-1 rounded-full border border-cool-gray-700 bg-cool-gray-200 p-x-small touch:h-x-large touch:px-tiny">
                              ...
                              <div className="flex items-center justify-center gap-x-x-small">
                                <button type="button" aria-label="Previous panel" disabled className="p-x-small">
                                  <img alt="" className="block w-large h-large" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-arrow-back--cool-gray-500.svg" />
                                </button>
                                <span className="whitespace-nowrap font-bold text-ui-extra-dark-cool typo-body-1">
                                  {"1 / 6"}
                                </span>
                                <button type="button" aria-label="Next panel" className="p-x-small">
                                  <img alt="" className="block w-large h-large" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-arrow-forward--text-tertiary.svg" />
                                </button>
                              </div>
                            </div>
                          </div>
                      ...
                      <div data-testid="tiles-wide">
                        <div className="cp-hidden lg:cp-block xl:cp-px-large" data-testid="hero">
                          <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container cp-h-full cp-rounded-none cp-px-none cp-pt-none xl:cp-rounded-lg xl:cp-p-small">
                            <div className="clickable-card cp-h-full cp-rounded-none xl:cp-rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                              <div className="grid h-full">
                                <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                ...
                                <div className="col-start-1 row-start-1 flex items-end">
                                  <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                    <div className="cp-mx-auto cp-mb-[9.5rem] cp-mt-auto lg:cp-m-none lg:cp-mt-auto">
                                      <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                        <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                          <h2 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":R2p6b5dmf6H1:">
                                            <span className="absolute -top-small right-large">
                                              <span className="inline-flex max-w-full items-center justify-center rounded-full border border-[rgba(254,250,246,0.70)] bg-red-700 px-x-small py-tiny text-text-invert shadow-red-glow">
                                                <span className="inline-flex overflow-hidden overflow-ellipsis whitespace-nowrap !leading-[0.86] px-small typo-label-4">
                                                  {"Now with Stuffed Crust"}
                                          ...
                                          <div className="cp-mt-tiny">
                                            <button type="button" aria-labelledby=":R2p6b5dmf6: :R2p6b5dmf6H1:" data-testid="tile-button-BestDealEver" id=":R2p6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                              {"Add deal"}
                                            </button>
                                          </div>
                                        </div>
                          ...
                          <div className="cp-my-medium cp-flex cp-items-end cp-justify-between cp-pr-medium xl:cp-pr-large">
                            ...
                            <div className="flex gap-regular">
                              <div className="pointer-events-none">
                                <button aria-label="Previous" aria-disabled="false" disabled className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed border border-warm-gray-800 disabled:bg-neutral-white disabled:opacity-30 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] border-warm-gray-400 bg-warm-gray-100 disabled:pointer-events-none w-xx-large p-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-arrow-back--warm-gray-400.svg" />
                                </button>
                              </div>
                              <div className="">
                                <button aria-label="Next" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed border border-warm-gray-800 disabled:bg-neutral-white disabled:opacity-30 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] bg-cool-gray-200 border [&:not([aria-disabled='true'])]:!border-cool-gray-800 hover:bg-cool-gray-300 active:bg-cool-gray-400 [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(240,222,204,0.50),0_0_0_3px_rgba(192,165,139,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-xx-large p-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-arrow-forward--text-tertiary.svg" />
                                </button>
                              </div>
                            </div>
                          </div>
                          <section aria-roledescription="carousel" className="no-scrollbar flex basis-1/2 snap-x snap-mandatory scroll-p-mega-1 justify-start gap-regular overflow-x-scroll scroll-smooth" data-testid="two-panel-carousel">
                                ...
                                <div className="clickable-card rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      ...
                                      <img src="/site-assets/cms/assets/fd735f00-674b-4c3c-9f57-97b57ad1c2b62f17.jpg?im=Crop,rect=(248,548,3203,1386);Resize=(1700),allowExpansion" alt="Mix and Match" loading="lazy" className="h-auto w-full rounded-lg object-cover" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                          <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                            <h3 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":R9dp6b5dmf6:">
                                              <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                <span>
                                                  {"Mix and match"}
                                                </span>
                                            ...
                                            <div className="cp-mt-tiny">
                                              <button type="button" aria-labelledby=":R9dp6b5dmf6H1: :R9dp6b5dmf6:" id=":R9dp6b5dmf6H1:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                {"Add deal"}
                                              </button>
                                            </div>
                                          </div>
                                ...
                                <div className="sm:flex-col mt-small flex items-center gap-x-small">
                                  <div>
                                    <div className="inline-block whitespace-nowrap">
                                      <button type="button" aria-labelledby=":R9dp6b5dmf6H2: :R9dp6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed bg-neutral-white shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] text-text-secondary hover:bg-cool-gray-300 border border-transparent hover:border-cool-gray-700 focus:border-cool-gray-700 focus:shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] focus:bg-neutral-white active:bg-cool-gray-400 active:border-transparent px-medium py-small typo-label-4 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                            ...
                            <div className="flex-shrink-0 snap-start w-[45%] flex-grow">
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container">
                                <div className="clickable-card rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      ...
                                      <img src="/site-assets/cms/assets/43778453-e8b1-4db6-83fa-00f2dc43d6e36846.jpg?im=Crop,rect=(374,325,3250,1441);Resize=(1700),allowExpansion" alt="Weeklong Carryout" loading="lazy" className="h-auto w-full rounded-lg object-cover" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                          <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                            <h3 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Radp6b5dmf6:">
                                              <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                <span>
                                                  {"Weeklong carryout"}
                                                </span>
                                            ...
                                            <div className="cp-mt-tiny">
                                              <button type="button" aria-labelledby=":Radp6b5dmf6H1: :Radp6b5dmf6:" id=":Radp6b5dmf6H1:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                {"Add deal"}
                                              </button>
                                            </div>
                                          </div>
                                ...
                                <div className="sm:flex-col mt-small flex items-center gap-x-small">
                                  <div>
                                    <div className="inline-block whitespace-nowrap">
                                      <button type="button" aria-labelledby=":Radp6b5dmf6H2: :Radp6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed bg-neutral-white shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] text-text-secondary hover:bg-cool-gray-300 border border-transparent hover:border-cool-gray-700 focus:border-cool-gray-700 focus:shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] focus:bg-neutral-white active:bg-cool-gray-400 active:border-transparent px-medium py-small typo-label-4 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                            ...
                            <div className="flex-shrink-0 snap-start w-[45%] flex-grow">
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container">
                                <div className="clickable-card rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      ...
                                      <img src="/site-assets/cms/assets/16279dec-7e30-45d5-9793-b839f36873af17fe.jpg?im=Crop,rect=(0,343,3615,1603);Resize=(1700),allowExpansion" alt="" loading="lazy" className="h-auto w-full rounded-lg object-cover" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                          <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                            <h3 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rbdp6b5dmf6:">
                                              <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                <span>
                                                  {"Parmesan Stuffed Crust"}
                                                </span>
                                            ...
                                            <div className="cp-mt-tiny">
                                              <button type="button" aria-labelledby=":Rbdp6b5dmf6H1: :Rbdp6b5dmf6:" id=":Rbdp6b5dmf6H1:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                {"Add deal"}
                                              </button>
                                            </div>
                                          </div>
                                ...
                                <div className="sm:flex-col mt-small flex items-center gap-x-small">
                                  <div>
                                    <div className="inline-block whitespace-nowrap">
                                      <button type="button" aria-labelledby=":Rbdp6b5dmf6H2: :Rbdp6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed bg-neutral-white shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] text-text-secondary hover:bg-cool-gray-300 border border-transparent hover:border-cool-gray-700 focus:border-cool-gray-700 focus:shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] focus:bg-neutral-white active:bg-cool-gray-400 active:border-transparent px-medium py-small typo-label-4 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                            ...
                            <div className="flex-shrink-0 snap-start w-[45%] flex-grow">
                              <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container">
                                  ...
                                  <div className="grid h-full">
                                    ...
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                          <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                            <h3 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rcdp6b5dmf6:">
                                              <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                <span>
                                                  {"The perfect combo"}
                                                </span>
                                            ...
                                            <div className="cp-mt-tiny">
                                              <button type="button" aria-labelledby=":Rcdp6b5dmf6H1: :Rcdp6b5dmf6:" id=":Rcdp6b5dmf6H1:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                                {"Add deal"}
                                              </button>
                                            </div>
                                          </div>
                                ...
                                <div className="sm:flex-col mt-small flex items-center gap-x-small">
                                  <div>
                                    <div className="inline-block whitespace-nowrap">
                                      <button type="button" aria-labelledby=":Rcdp6b5dmf6H2: :Rcdp6b5dmf6:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed bg-neutral-white shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] text-text-secondary hover:bg-cool-gray-300 border border-transparent hover:border-cool-gray-700 focus:border-cool-gray-700 focus:shadow-[0_2px_6px_0_rgba(120,84,49,0.10)] focus:bg-neutral-white active:bg-cool-gray-400 active:border-transparent px-medium py-small typo-label-4 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                                ...
                                <div className="clickable-card rounded-lg active:outline active:outline-blue" data-testid="clickable-card">
                                  <div className="grid h-full">
                                    <picture className="col-start-1 row-start-1 h-full overflow-hidden">
                                      ...
                                      <source media="(min-width: 500px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(151,105,1200,749);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(151,105,1200,749);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(151,105,1200,749);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(151,105,1200,749);Resize=(1700),allowExpansion 1700w" />
                                      <source media="(max-width: 500px)" sizes="(max-width: 1700px) 100vw, 1700px" srcSet="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(390),allowExpansion 390w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(500),allowExpansion 500w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(1000),allowExpansion 1000w, /site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27f2417.jpg?im=Crop,rect=(500,3,500,851);Resize=(1700),allowExpansion 1700w" />
                                      <img src="/site-assets/cms/assets/295ee22e-705d-47e3-8ad3-4ed180a8f27fb339.jpg?im=Crop,rect=(74,144,1400,621);Resize=(1700),allowExpansion" alt="" loading="lazy" className="h-auto w-full rounded-lg object-cover" />
                                    </picture>
                                    <div className="col-start-1 row-start-1 flex items-end">
                                      <div className="cp-flex cp-h-full cp-w-full cp-flex-col cp-justify-between">
                                        <div className="relative m-small mt-auto flex flex-col gap-small rounded-3xl bg-cool-gray-100/90 p-regular shadow-tile-card backdrop-blur-tile-card @sm:max-w-[19.5rem] @5xl:max-w-[30rem] @5xl:p-large">
                                          <div className="flex flex-col gap-tiny @5xl:gap-x-small">
                                            <h3 className="@5xl:cp-gap-x-small cp-flex cp-flex-col cp-gap-tiny" id=":Rddp6b5dmf6:">
                                              <span className="block text-accessible-blue typo-offer-subhead-small @5xl:typo-offer-subhead-large">
                                                <span>
                                                  {"Local deals"}
                                                </span>
                      ...
                      <div className="flex flex-col rounded-lg bg-cool-gray-200 p-small @container">
                        ...
                        <div className="sm:flex-col mt-small flex items-center gap-x-small cp-w-full cp-flex-col cp-items-start cp-self-start md:cp-flex-row md:cp-items-center">
                          <div className="cp-w-full cp-whitespace-nowrap md:cp-ml-auto md:cp-w-auto">
                            <button type="button" aria-labelledby=":Rsqb5dmf6H1: :Rsqb5dmf6:" id=":Rsqb5dmf6H1:" className="w-full rounded-full text-center outline-none duration-75 disabled:active:scale-100 [&:not([aria-disabled='true'])]:active:scale-95 flex items-center justify-center gap-small aria-disabled:cursor-not-allowed [&:not([aria-disabled='true'])]:hover:bg-wine [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:active:shadow-none disabled:border-warm-gray-400 disabled:bg-warm-gray-400 focus:shadow-button-primary text-text-invert bg-accessible-red [box-shadow:0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-red-1000 [&:not([aria-disabled='true'])]:focus:bg-accessible-red [&:not([aria-disabled='true'])]:focus:[box-shadow:0_0_0_2px_#FFF,0_0_0_4px_rgba(255,0,0,0.70),0_0_5px_4px_rgba(255,0,0,0.50)] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&[aria-disabled='true']]:shadow-none disabled:bg-warm-gray-400 disabled:text-text-invert disabled:[box-shadow:none] disabled:pointer-events-none px-medium py-small typo-label-4 @5xl:!px-large @5xl:!py-regular @5xl:!typo-label-2 relative active:after:content-[''] active:after:absolute active:after:inline-block active:after:inset-none active:after:scale-x-105 active:after:scale-y-110">
                              {"Order Now"}
                            </button>
                          </div>
                        </div>
                ...
                <div className="rw-rounded-lg rw-bg-cool-gray-200">
                  <div className="rw-grid rw-grid-cols-1 rw-gap-regular md:rw-p-small lg:rw-grid-cols-[1fr_2fr]">
                    ...
                    <div className="rw-hidden lg:rw-flex">
                      <img className="rw-h-[24rem] rw-w-full rw-object-contain" alt="" src="/site-assets/cms/assets/270b93c2-a629-4541-bfc0-b8d6b9a7320f6967.png?im=Resize%3D%28750%29" loading="lazy" />
                    </div>
                  </div>
                  <div className="rw-flex rw-items-center rw-justify-center rw-rounded-b-lg rw-bg-cool-gray-200">
                    <span className="rw-p-small rw-font-medium rw-text-ui-dark-cool rw-typo-label-5">
                      {"See Domino's® Rewards"}
                      <button type="button" className="font-sans underline p-tiny font-bold text-ui-dark-cool hover:text-opacity-90">
                        {"Terms & Conditions"}
                      </button>
                    </span>
                  </div>
                </div>
                <section className="sh-flex sh-flex-col sh-gap-large">
                  <h2 className="sh-text-blue-600 sh-typo-headline-2">
                    {"Browse Menu"}
                  </h2>
                  <article>
