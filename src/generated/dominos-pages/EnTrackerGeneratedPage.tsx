...
export const metadata: Metadata = {
  "title": "Order Tracker | Domino's",
  "description": "Track your order to the front door with Domino's tracker by staying updated in real time about your order. Submit your phone number to track your order.",
  "alternates": {
...
export function EnTrackerGeneratedPage() {
  return (
    <>
    <div id="__next">
