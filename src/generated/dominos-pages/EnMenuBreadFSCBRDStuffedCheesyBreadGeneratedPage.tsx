...
export const metadata: Metadata = {
  "title": "Stuffed Cheesy Bread Near Me | Domino's",
  "description": "Order your favorite Domino's Stuffed Cheesy Bread online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/bread/F_SCBRD/stuffed_cheesy_bread"
  },
  "robots": "index"
};

export function EnMenuBreadFSCBRDStuffedCheesyBreadGeneratedPage() {
  return (
    <>
    <div id="__next">
