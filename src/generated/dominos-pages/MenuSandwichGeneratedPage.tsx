...
export function MenuSandwichGeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sandwich/S_PHIL/philly_cheese_steak">
                              {"Customize "}
                              {"Philly Cheese Steak"}
                            </Link>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sandwich/S_CHIKK/chicken_bacon_ranch">
                              {"Customize "}
                              {"Chicken Bacon Ranch"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sandwich/S_ITALIAN/italian">
                              {"Customize "}
                              {"Italian"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sandwich/S_CHIKP/chicken_parm">
                              {"Customize "}
                              {"Chicken Parm"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/sandwich/S_BUFC/buffalo_chicken">
                              {"Customize "}
                              {"Buffalo Chicken"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
