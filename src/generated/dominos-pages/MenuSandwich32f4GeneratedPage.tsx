...
export const metadata: Metadata = {
  "title": "sandwich?type=order_delivery Near Me",
  "description": "Order your favorite Domino's sandwich?type=order_delivery online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function MenuSandwich32f4GeneratedPage() {
  return (
    <>
    <div id="__next">
