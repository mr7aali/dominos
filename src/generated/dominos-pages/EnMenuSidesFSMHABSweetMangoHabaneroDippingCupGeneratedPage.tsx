...
export const metadata: Metadata = {
  "title": "sweet_mango_habanero_dipping_cup Near Me",
  "description": "Order your favorite Domino's sweet_mango_habanero_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_SMHAB/sweet_mango_habanero_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFSMHABSweetMangoHabaneroDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
