...
export const metadata: Metadata = {
  "title": "Chicken Alfredo Pasta Near Me | Domino's",
  "description": "Order your favorite Domino's Chicken Alfredo pasta online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/pasta/S_ALFR/chicken_alfredo"
  },
  "robots": "index"
};

export function EnMenuPastaSALFRChickenAlfredoGeneratedPage() {
  return (
    <>
    <div id="__next">
