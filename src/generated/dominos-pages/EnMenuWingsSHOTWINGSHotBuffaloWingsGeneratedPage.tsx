...
export const metadata: Metadata = {
  "title": "Hot Buffalo Wings Near Me | Domino's",
  "description": "Order your favorite Domino's Hot Buffalo wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_HOTWINGS/hot_buffalo_wings"
  },
  "robots": "index"
};

export function EnMenuWingsSHOTWINGSHotBuffaloWingsGeneratedPage() {
  return (
    <>
    <div id="__next">
