...
export const metadata: Metadata = {
  "title": "Garlic Parmesan Wings Near Me | Domino's",
  "description": "Order your favorite Domino's Garlic Parmesan wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_GPRMWING/garlic_parmesan_wings"
  },
  "robots": "index"
};

export function EnMenuWingsSGPRMWINGGarlicParmesanWingsGeneratedPage() {
  return (
    <>
    <div id="__next">
