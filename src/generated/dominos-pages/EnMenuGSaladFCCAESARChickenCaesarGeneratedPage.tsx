...
export const metadata: Metadata = {
  "title": "Chicken Caesar Salad Near Me | Domino's",
  "description": "Order your favorite Domino's Chicken Caesar salad online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/g-salad/F_CCAESAR/chicken_caesar"
  },
  "robots": "index"
};

export function EnMenuGSaladFCCAESARChickenCaesarGeneratedPage() {
  return (
    <>
    <div id="__next">
