...
export const metadata: Metadata = {
  "title": "Sweet Mango Habanero Wings Near Me | Domino's",
  "description": "Order your favorite Domino's Sweet Mango Habanero wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_SMANG/sweet_mango_habanero_wings"
  },
  "robots": "index"
};

export function EnMenuWingsSSMANGSweetMangoHabaneroWingsGeneratedPage() {
  return (
    <>
    <div id="__next">
