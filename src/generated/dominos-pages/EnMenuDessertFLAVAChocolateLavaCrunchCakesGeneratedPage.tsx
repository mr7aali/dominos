...
export const metadata: Metadata = {
  "title": "chocolate_lava_crunch_cakes Near Me",
  "description": "Order your favorite Domino's chocolate_lava_crunch_cakes online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/dessert/F_LAVA/chocolate_lava_crunch_cakes"
  },
  "robots": "index"
};

export function EnMenuDessertFLAVAChocolateLavaCrunchCakesGeneratedPage() {
  return (
    <>
    <div id="__next">
