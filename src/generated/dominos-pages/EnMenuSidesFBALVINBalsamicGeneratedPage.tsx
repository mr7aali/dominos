...
export const metadata: Metadata = {
  "title": "balsamic Near Me",
  "description": "Order your favorite Domino's balsamic online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_BALVIN/balsamic"
  },
  "robots": "index"
};

export function EnMenuSidesFBALVINBalsamicGeneratedPage() {
  return (
    <>
    <div id="__next">
