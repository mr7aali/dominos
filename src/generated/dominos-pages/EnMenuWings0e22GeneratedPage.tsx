...
export const metadata: Metadata = {
  "title": "wings?gad_campaignid=855088965&gad_source=1&gbraid=0AAAAADeMJnBwI7_wDo9qQ_pUPptIrifIk&gclid=Cj0KCQjwsPzHBhDCARIsALlWNG03abXv3pRBSa0tIV1DDbwzHpKq1bKtFwkfIqtZMWX0n4YcuSgckhsaAhRJEALw_wcB%2FS_SCSBBQ%2Floaded_chicken_sweet_bbq_bacon&matchtype=b%2FS_SCSJP%2Floaded_chicken_spicy_jalapeno_pineapple%2FS_SCSBBQ%2Floaded_chicken_sweet_bbq_bacon%2FS_SCCHB%2Floaded_chicken_classic_hot_buffalo%2FS_PLNWINGS%2Fplain_wings%2FS_GPRMWING%2Fgarlic_parmesan_wings%2FS_GPRMWING%2Fgarlic_parmesan_wings%2FS_HOTWINGS%2Fhot_buffalo_wings%2FS_BONELESS%2Fboneless_chicken%2FS_SCCBT%2Floaded_chicken_crispy_bacon_tomato%2FS_BBQW%2Fhoney_bbq_wings%2FS_SCCBT%2Floaded_chicken_crispy_bacon_tomato%2FS_SCSBBQ%2Floaded_chicken_sweet_bbq_bacon%2FS_BBQW%2Fhoney_bbq_wings%2FS_BONELESS%2Fboneless_chicken%2FS_SCCBT%2Floaded_chicken_crispy_bacon_tomato Near Me",
  "description": "Order your favorite Domino's wings?gad_campaignid=855088965&gad_source=1&gbraid=0AAAAADeMJnBwI7_wDo9qQ_pUPptIrifIk&gclid=Cj0KCQjwsPzHBhDCARIsALlWNG03abXv3pRBSa0tIV1DDbwzHpKq1bKtFwkfIqtZMWX0n4YcuSgckhsaAhRJEALw_wcB%2FS_SCSBBQ%2Floaded_chicken_sweet_bbq_bacon&matchtype=b%2FS_SCSJP%2Floaded_chicken_spicy_jalapeno_pineapple%2FS_SCSBBQ%2Floaded_chicken_sweet_bbq_bacon%2FS_SCCHB%2Floaded_chicken_classic_hot_buffalo%2FS_PLNWINGS%2Fplain_wings%2FS_GPRMWING%2Fgarlic_parmesan_wings%2FS_GPRMWING%2Fgarlic_parmesan_wings%2FS_HOTWINGS%2Fhot_buffalo_wings%2FS_BONELESS%2Fboneless_chicken%2FS_SCCBT%2Floaded_chicken_crispy_bacon_tomato%2FS_BBQW%2Fhoney_bbq_wings%2FS_SCCBT%2Floaded_chicken_crispy_bacon_tomato%2FS_SCSBBQ%2Floaded_chicken_sweet_bbq_bacon%2FS_BBQW%2Fhoney_bbq_wings%2FS_BONELESS%2Fboneless_chicken%2FS_SCCBT%2Floaded_chicken_crispy_bacon_tomato online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuWings0e22GeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_SCCBT/loaded_chicken_crispy_bacon_tomato">
                              {"Customize "}
                              {"Loaded Chicken – Crispy Bacon & Tomato"}
                            </Link>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_SCCHB/loaded_chicken_classic_hot_buffalo">
                              {"Customize "}
                              {"Loaded Chicken – Classic Hot Buffalo"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_SCSJP/loaded_chicken_spicy_jalapeno_pineapple">
                              {"Customize "}
                              {"Loaded Chicken – Spicy Jalapeno - Pineapple"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_SCSBBQ/loaded_chicken_sweet_bbq_bacon">
                              {"Customize "}
                              {"Loaded Chicken – Sweet BBQ Bacon"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_HOTWINGS/hot_buffalo_wings">
                              {"Customize "}
                              {"Hot Buffalo Wings"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_BBQW/honey_bbq_wings">
                              {"Customize "}
                              {"Honey BBQ Wings"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_PLNWINGS/plain_wings">
                              {"Customize "}
                              {"Plain Wings"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_SMANG/sweet_mango_habanero_wings">
                              {"Customize "}
                              {"Sweet Mango Habanero Wings"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_GPRMWING/garlic_parmesan_wings">
                              {"Customize "}
                              {"Garlic Parmesan Wings"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/wings/S_BONELESS/boneless_chicken">
                              {"Customize "}
                              {"Boneless Chicken"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
