...
export const metadata: Metadata = {
  "title": "Philly Cheese Steak Sandwich Near Me | Domino's",
  "description": "Order your favorite Domino's Philly Cheese Steak sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sandwich/S_PHIL/philly_cheese_steak"
  },
  "robots": "index"
};

export function EnMenuSandwichSPHILPhillyCheeseSteakGeneratedPage() {
  return (
    <>
    <div id="__next">
