...
export const metadata: Metadata = {
  "title": "Chicken & Wings Near Me | Domino's",
  "description": "Order your favorite Domino's hot wings, BBQ wings, & boneless chicken online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuWings32f4GeneratedPage() {
  return (
    <>
    <div id="__next">
