...
export const metadata: Metadata = {
  "title": "the_peoples_pizza_deluxe Near Me",
  "description": "Order your favorite Domino's the_peoples_pizza_deluxe online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_DX/the_peoples_pizza_deluxe"
  },
  "robots": "index"
};

export function EnMenuSpecialtySDXThePeoplesPizzaDeluxeGeneratedPage() {
  return (
    <>
    <div id="__next">
