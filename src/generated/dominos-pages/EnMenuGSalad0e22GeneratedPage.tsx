...
export const metadata: Metadata = {
  "title": "g-salad?type=order_carryout Near Me",
  "description": "Order your favorite Domino's g-salad?type=order_carryout online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuGSalad0e22GeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/g-salad/F_GARDEN/classic_garden">
                              {"Customize "}
                              {"Classic Garden"}
                            </Link>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/g-salad/F_CCAESAR/chicken_caesar">
                              {"Customize "}
                              {"Chicken Caesar"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
