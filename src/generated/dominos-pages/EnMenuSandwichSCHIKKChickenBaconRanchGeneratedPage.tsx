...
export const metadata: Metadata = {
  "title": "Chicken Bacon Ranch Sandwich Near Me | Domino's",
  "description": "Order your favorite Domino's Chicken Bacon Ranch sandwich online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sandwich/S_CHIKK/chicken_bacon_ranch"
  },
  "robots": "index"
};

export function EnMenuSandwichSCHIKKChickenBaconRanchGeneratedPage() {
  return (
    <>
    <div id="__next">
