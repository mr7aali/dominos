...
export const metadata: Metadata = {
  "title": "Domino's Rewards | Domino's",
  "description": "Discover and learn more about Domino's Rewards. Earn rewards on pizza, wings, sandwiches & more with Domino's.",
  "alternates": {
    "canonical": "/en/my-deals-and-rewards"
  },
  "robots": "index"
};

export function EnMyDealsAndRewardsGeneratedPage() {
  return (
    <>
    <div id="__next">
