...
export const metadata: Metadata = {
  "title": "spicy_buffalo_5cheese_mac_cheese Near Me",
  "description": "Order your favorite Domino's spicy_buffalo_5cheese_mac_cheese online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/pasta/S_BUFFALO/spicy_buffalo_5cheese_mac_cheese"
  },
  "robots": "index"
};

export function EnMenuPastaSBUFFALOSpicyBuffalo5cheeseMacCheeseGeneratedPage() {
  return (
    <>
    <div id="__next">
