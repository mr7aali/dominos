...
export function MenuDessert0e22GeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/dessert/F_CBITES/cinnamon_bread_bites">
                              {"Customize "}
                              {"Cinnamon Bread Bites"}
                            </Link>
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/dessert/F_MRBRWNE/dominos_marbled_cookie_brownie">
                              {"Customize "}
                              {"Domino's Marbled Cookie Brownie"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                    ...
                    <li>
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        ...
                        <div className="group relative order-first">
                          ...
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/menu/dessert/F_LAVA/chocolate_lava_crunch_cakes">
                              {"Customize "}
                              {"Chocolate Lava Crunch Cakes"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
