...
export const metadata: Metadata = {
  "title": "Coke Near Me | Domino's",
  "description": "Order your favorite Domino's Coke online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/drinks/F_COKE/coke"
  },
  "robots": "index"
};

export function EnMenuDrinksFCOKECokeGeneratedPage() {
  return (
    <>
    <div id="__next">
