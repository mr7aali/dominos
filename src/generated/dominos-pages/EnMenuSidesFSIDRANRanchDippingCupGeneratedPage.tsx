...
export const metadata: Metadata = {
  "title": "ranch_dipping_cup Near Me",
  "description": "Order your favorite Domino's ranch_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_SIDRAN/ranch_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFSIDRANRanchDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
