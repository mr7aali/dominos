...
export const metadata: Metadata = {
  "title": "Boneless Wings Near Me | Domino's",
  "description": "Order your favorite Domino's Boneless wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_BONELESS/boneless_chicken"
  },
  "robots": "index"
};

export function EnMenuWingsSBONELESSBonelessChickenGeneratedPage() {
  return (
    <>
    <div id="__next">
