...
export const metadata: Metadata = {
  "title": "Pasta Near Me | Domino's",
  "description": "Order your favorite Domino's pasta online or build your own! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuPastaGeneratedPage() {
  return (
    <>
    <div id="__next">
