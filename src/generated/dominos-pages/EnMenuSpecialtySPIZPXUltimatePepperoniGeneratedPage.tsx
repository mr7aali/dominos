...
export const metadata: Metadata = {
  "title": "Ultimate Pepperoni Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Ultimate Pepperoni pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZPX/ultimate_pepperoni"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZPXUltimatePepperoniGeneratedPage() {
  return (
    <>
    <div id="__next">
