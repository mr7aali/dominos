...
export const metadata: Metadata = {
  "title": "garlic_dipping_cup Near Me",
  "description": "Order your favorite Domino's garlic_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_SIDGAR/garlic_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFSIDGARGarlicDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
