...
export const metadata: Metadata = {
  "title": "5cheese_mac_cheese Near Me",
  "description": "Order your favorite Domino's 5cheese_mac_cheese online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/pasta/S_5CHSMAC/5cheese_mac_cheese"
  },
  "robots": "index"
};

export function EnMenuPastaS5CHSMAC5cheeseMacCheeseGeneratedPage() {
  return (
    <>
    <div id="__next">
