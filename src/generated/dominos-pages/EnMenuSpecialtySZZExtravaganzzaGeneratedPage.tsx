...
export const metadata: Metadata = {
  "title": "ExtravaganZZa Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's ExtravaganZZa pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_ZZ/extravaganzza"
  },
  "robots": "index"
};

export function EnMenuSpecialtySZZExtravaganzzaGeneratedPage() {
  return (
    <>
    <div id="__next">
