...
export const metadata: Metadata = {
  "title": "Hot Sandwiches Near Me | Domino's",
  "description": "Order your favorite Domino's sandwiches online, including Italian, Buffalo Chicken & more! Sign up for email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sandwich"
  },
  "robots": "index"
};

export function EnMenuSandwich0e22GeneratedPage() {
  return (
    <>
    <div id="__next">
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"Deliciously tender slices of steak, American and provolone cheeses, fresh onions, fresh green peppers and fresh mushrooms."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Philly Cheese Steak-source-xl" srcSet="/site-assets/cms/assets/79434f39-e8ee-491b-baff-c4d54154dc6fa031.png?modified_on=2026-04-24T19%3A15%3A56.798Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Philly Cheese Steak-source-lg" srcSet="/site-assets/cms/assets/79434f39-e8ee-491b-baff-c4d54154dc6fa031.png?modified_on=2026-04-24T19%3A15%3A56.798Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Philly Cheese Steak-source-md" srcSet="/site-assets/cms/assets/79434f39-e8ee-491b-baff-c4d54154dc6fa031.png?modified_on=2026-04-24T19%3A15%3A56.798Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C228%2C228%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Philly Cheese Steak-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/79434f39-e8ee-491b-baff-c4d54154dc6fa031.png?modified_on=2026-04-24T19%3A15%3A56.798Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sandwich/S_PHIL/philly_cheese_steak">
                              {"Customize "}
                              {"Philly Cheese Steak"}
                            </Link>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"Grilled chicken breast topped with smoked bacon, creamy ranch and provolone cheese."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Chicken Bacon Ranch-source-xl" srcSet="/site-assets/cms/assets/409e3875-7647-41b9-86b1-4ba3ef231f0afcd8.png?modified_on=2026-04-24T19%3A30%3A44.828Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Chicken Bacon Ranch-source-lg" srcSet="/site-assets/cms/assets/409e3875-7647-41b9-86b1-4ba3ef231f0afcd8.png?modified_on=2026-04-24T19%3A30%3A44.828Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Chicken Bacon Ranch-source-md" srcSet="/site-assets/cms/assets/409e3875-7647-41b9-86b1-4ba3ef231f0afcd8.png?modified_on=2026-04-24T19%3A30%3A44.828Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C228%2C228%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Chicken Bacon Ranch-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/409e3875-7647-41b9-86b1-4ba3ef231f0afcd8.png?modified_on=2026-04-24T19%3A30%3A44.828Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sandwich/S_CHIKK/chicken_bacon_ranch">
                              {"Customize "}
                              {"Chicken Bacon Ranch"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Chicken Bacon Ranch to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Chicken Bacon Ranch" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Chicken Bacon Ranch" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"Pepperoni and ham topped with banana peppers, fresh green peppers, fresh onions, and provolone cheese."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Italian-source-xl" srcSet="/site-assets/cms/assets/86d7f569-ff6f-4a44-8321-4e3e2bfa4c00879a.png?modified_on=2026-04-24T19%3A34%3A15.624Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Italian-source-lg" srcSet="/site-assets/cms/assets/86d7f569-ff6f-4a44-8321-4e3e2bfa4c00879a.png?modified_on=2026-04-24T19%3A34%3A15.624Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Italian-source-md" srcSet="/site-assets/cms/assets/86d7f569-ff6f-4a44-8321-4e3e2bfa4c00879a.png?modified_on=2026-04-24T19%3A34%3A15.624Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C228%2C228%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Italian-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/86d7f569-ff6f-4a44-8321-4e3e2bfa4c00879a.png?modified_on=2026-04-24T19%3A34%3A15.624Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sandwich/S_ITALIAN/italian">
                              {"Customize "}
                              {"Italian"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Italian to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Italian" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Italian" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"Grilled chicken breast, robust-inspired tomato sauce, Parmesan-Asiago and provolone cheese, finished with melted cheese made with 100% mozzarella.​"}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Chicken Parm-source-xl" srcSet="/site-assets/cms/assets/e36abdda-8939-4ace-a4c0-0143b7b311200985.png?modified_on=2026-04-24T19%3A37%3A22.508Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Chicken Parm-source-lg" srcSet="/site-assets/cms/assets/e36abdda-8939-4ace-a4c0-0143b7b311200985.png?modified_on=2026-04-24T19%3A37%3A22.508Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Chicken Parm-source-md" srcSet="/site-assets/cms/assets/e36abdda-8939-4ace-a4c0-0143b7b311200985.png?modified_on=2026-04-24T19%3A37%3A22.508Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C228%2C228%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Chicken Parm-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/e36abdda-8939-4ace-a4c0-0143b7b311200985.png?modified_on=2026-04-24T19%3A37%3A22.508Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sandwich/S_CHIKP/chicken_parm">
                              {"Customize "}
                              {"Chicken Parm"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Chicken Parm to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Chicken Parm" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Chicken Parm" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
                      ...
                      <div className="clickable-card flex flex-col gap-regular rounded-xl !outline-none active:outline active:outline-blue" data-testid="clickable-card">
                        <div className="order-last flex flex-col gap-x-small">
                          <div className="flex flex-col gap-tiny">
                            ...
                            <p className="text-text-secondary typo-body-2 lg:typo-body-1 line-clamp-3">
                              {"Grilled chicken breast, ranch, fresh onions, hot buffalo sauce, cheddar, and cheese made with 100% real mozzarella."}
                            </p>
                          </div>
                        </div>
                        <div className="group relative order-first">
                          <div className="relative flex aspect-square justify-end overflow-hidden rounded-xl border-solid border-2 border-transparent bg-cool-gray-200 group-hover:border-cool-gray-700 group-active:border-blue">
                            <picture>
                              <source data-testid="Buffalo Chicken-source-xl" srcSet="/site-assets/cms/assets/a23ef260-0adc-4d7d-b352-d0706faa3c970140.png?modified_on=2026-04-24T19%3A40%3A30.693Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1700px)" />
                              <source data-testid="Buffalo Chicken-source-lg" srcSet="/site-assets/cms/assets/a23ef260-0adc-4d7d-b352-d0706faa3c970140.png?modified_on=2026-04-24T19%3A40%3A30.693Z&im=Resize%3D%28703%2C703%29%3BCrop%2Crect%3D%28294%2C176%2C431%2C431%29%2CallowExpansion" media="(min-width: 1000px)" />
                              <source data-testid="Buffalo Chicken-source-md" srcSet="/site-assets/cms/assets/a23ef260-0adc-4d7d-b352-d0706faa3c970140.png?modified_on=2026-04-24T19%3A40%3A30.693Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C228%2C228%29%2CallowExpansion" media="(min-width: 500px)" />
                              <img className="min-h-full min-w-full object-right" data-testid="Buffalo Chicken-img-sm" alt="" loading="lazy" src="/site-assets/cms/assets/a23ef260-0adc-4d7d-b352-d0706faa3c970140.png?modified_on=2026-04-24T19%3A40%3A30.693Z&im=Resize%3D%28426%2C426%29%3BCrop%2Crect%3D%28200%2C130%2C234%2C234%29%2CallowExpansion" />
                            </picture>
                          </div>
                          <div className="absolute inset-none m-small flex flex-col items-end justify-end lg:flex-row">
                            <Link className="sr-only" href="/en/menu/sandwich/S_BUFC/buffalo_chicken">
                              {"Customize "}
                              {"Buffalo Chicken"}
                            </Link>
                            <div className="pd-rounded-full pd-transition-all pd-duration-400 motion-reduce:pd-transition-none">
                              <span className="">
                                <button aria-label="Add Buffalo Chicken to Cart" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-red bg-red-default border border-neutral-white [&:not([aria-disabled='true'])]:hover:bg-red-800 [&:not([aria-disabled='true'])]:active:bg-wine [&:not([aria-disabled='true'])]:focus:shadow-button-primary disabled:bg-ui-background-border [&:not([aria-disabled='false'])]:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:shadow-[0_0_2px_0_rgba(255,73,73,0.40),1px_1px_10px_0_rgba(255,73,73,0.30)] [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(227,24,55,0.70),0_0_0_4px_#E31837] [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] [&:not([aria-disabled='true'])]:active:bg-red-900 disabled:bg-warm-gray-400 disabled:pointer-events-none h-x-large w-x-large p-x-small rounded-full aspect-square" type="button">
                                  <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/icon-type-add-cart--background-primary.svg" />
                                </button>
                              </span>
                              <div className="pd-h-x-large pd-w-x-large pd-hidden"></div>
                            ...
                            <div hidden style={{ display: "none" }}>
                              <div className="w-fit rounded-full border border-cool-gray-700 bg-cool-gray-200 p-tiny leading-none shadow-[0_2px_6px_0_rgba(120,84,49,0.10)]">
                                <div className="inline-flex items-center justify-center gap-small leading-none">
                                  <button aria-label="Remove one Buffalo Chicken" aria-disabled="true" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square cursor-not-allowed bg-cool-gray-500 pointer-events-none border" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/minus--text-tertiary.svg" />
                                  </button>
                                  <div role="status" aria-busy="false" className="flex justify-center">
                                    <span className="w-medium p-none text-center font-bold leading-none text-text-primary typo-body-1" data-testid="quantity-selector-value" aria-hidden="true">
                                  ...
                                  <button aria-label="Add one Buffalo Chicken" aria-disabled="false" className="inline-flex w-fit items-center justify-center disabled:cursor-not-allowed bg-blue [&:not([aria-disabled='true'])]:hover:bg-blue-900 disabled:bg-ui-background-border border-none [&:not([aria-disabled='true'])]:focus:shadow-[0_0_5px_4px_rgba(0,144,226,0.70),0_0_0_4px_rgba(0,144,226,0.50)] disabled:bg-warm-gray-400 disabled:pointer-events-none [&:not([aria-disabled='true'])]:active:bg-blue-1000 [&:not([aria-disabled='true'])]:active:focus:[box-shadow:none] w-large p-tiny rounded-full aspect-square" type="button">
                                    <img alt="" className="block w-regular h-regular" src="/site-assets/dpz-ecomm-makeline-ui-mfe/icons/modern/plus--background-primary.svg" />
                                  </button>
                                </div>
                              </div>
