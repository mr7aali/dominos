...
export const metadata: Metadata = {
  "title": "Dasani Bottled Water Near Me | Domino's",
  "description": "Order your favorite Domino's Dasani Bottled Water online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/drinks/F_WATER/dasani_bottle_water"
  },
  "robots": "index"
};

export function EnMenuDrinksFWATERDasaniBottleWaterGeneratedPage() {
  return (
    <>
    <div id="__next">
