...
export const metadata: Metadata = {
  "title": "Sauce & Dressing | Domino's",
  "description": "Order your favorite Domino's dipping sauce, including Garlic, Hot Buffalo, & more! Sign up for email & text offers to get great deals on your next order.",
  "alternates": {
...
export function MenuSidesGeneratedPage() {
  return (
    <>
    <div id="__next">
