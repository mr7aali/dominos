...
export const metadata: Metadata = {
  "title": "Honey BBQ Wings Near Me | Domino's",
  "description": "Order your favorite Domino's Honey BBQ wings online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_BBQW/honey_bbq_wings"
  },
  "robots": "index"
};

export function EnMenuWingsSBBQWHoneyBbqWingsGeneratedPage() {
  return (
    <>
    <div id="__next">
