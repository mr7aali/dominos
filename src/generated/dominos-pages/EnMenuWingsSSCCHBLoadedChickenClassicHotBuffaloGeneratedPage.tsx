...
export const metadata: Metadata = {
  "title": "Classic Hot Buffalo Specialty Chicken | Domino's",
  "description": "Order your favorite Domino's Hot Buffalo Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_SCCHB/loaded_chicken_classic_hot_buffalo"
  },
  "robots": "index"
};

export function EnMenuWingsSSCCHBLoadedChickenClassicHotBuffaloGeneratedPage() {
  return (
    <>
    <div id="__next">
