...
export const metadata: Metadata = {
  "title": "honey_bbq_dipping_cup Near Me",
  "description": "Order your favorite Domino's honey_bbq_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_BBQC/honey_bbq_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFBBQCHoneyBbqDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
