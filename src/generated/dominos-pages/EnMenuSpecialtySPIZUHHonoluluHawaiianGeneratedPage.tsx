...
export const metadata: Metadata = {
  "title": "Honolulu Hawaiian Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Honolulu Hawaiian pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZUH/honolulu_hawaiian"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZUHHonoluluHawaiianGeneratedPage() {
  return (
    <>
    <div id="__next">
