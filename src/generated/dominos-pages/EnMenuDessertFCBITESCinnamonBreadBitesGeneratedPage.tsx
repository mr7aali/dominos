...
export const metadata: Metadata = {
  "title": "Cinnamon Bread Bites Near Me | Domino's",
  "description": "Order your favorite Domino's Cinnamon Bread Bites online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/dessert/F_CBITES/cinnamon_bread_bites"
  },
  "robots": "index"
};

export function EnMenuDessertFCBITESCinnamonBreadBitesGeneratedPage() {
  return (
    <>
    <div id="__next">
