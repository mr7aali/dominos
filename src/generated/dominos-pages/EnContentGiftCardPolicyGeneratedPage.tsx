...
export function EnContentGiftCardPolicyGeneratedPage() {
  return (
    <>
    <div id="__next">
              ...
              <div className="flex w-full max-w-screen-xl flex-col gap-xx-large self-center px-medium pb-xx-large pt-x-large md:gap-mega-1 md:px-x-large md:pb-mega-1 lg:gap-mega-1 lg:pb-mega-1 lg:pt-mega-1">
                <div className="sh-p-regular">
                  <div>
                    ...
                    <h2 id="before-using-the-card" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Before Using the Card"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"Each Card has a maximum Available Funds limit of $100.00. We suggest that you write down the Card number and the customer service number on a separate piece of paper, and print, if necessary, and retain the receipt for the Card. Lost, stolen, or destroyed cards will only be replaced if there is a balance on the card and proof of purchase is provided. Please see the section below entitled \"Refunds and Replacements\" for complete details."}
                    </p>
                    <h2 id="using-the-card" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Using the Card"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"We may assign this agreement to a successor, affiliate, parent or subsidiary at any time without notice to you."}
                    </p>
                    <h2 id="notices" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Notices"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"As part of providing you with the Gift Card (\"Card\") and during activation of the Card we may collect and obtain personal information about you, including:"}
                    </p>
                    <ul className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1 sh-list-disc sh-space-y-small sh-ml-regular sh-pl-regular">
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"Information provided to us by the Card purchaser, such as name and/or address."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"Information you provide to us at the time of activation."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"Information about purchases you make with the Card, such as the date of the purchase, the amount and the place of purchase."}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"In addition, we may obtain information from providers of identity verification data and demographic information, in connection with any efforts to protect against fraudulent or unauthorized use of the Card."}
                      </li>
                    </ul>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"If you conduct transactions through www.dominos.com, we will collect information about the transactions you engage in while on the website and your other activity on the website. This information may include, without limitation, areas of the website that you visit, transaction type, content that you view, download or submit, transaction amount, payment, and billing information as well as the nature, quantity and price of the goods or services you exchange and the individuals or entities with whom you communicate or transact business. You may also choose to communicate with us through email, via our website, by telephone, in writing, or through other means. We collect the information in these communications, and such information may be personally identifiable."}
                    </p>
                    <h2 id="information-use" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                      {"Information Use"}
                    </h2>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                    ...
                    <ul className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1 sh-list-disc sh-space-y-small sh-ml-regular sh-pl-regular">
                      ...
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"opening, maintaining, administering and servicing your account;"}
                      </li>
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                      ...
                      <li className="sh-text-ui-dark-cool sh-typo-body-1">
                        {"may also use aggregated anonymous information to provide information about its website to potential business partners and other unaffiliated entities. Again, this information is not personally identifiable."}
                      </li>
                    </ul>
                    <h2 id="disclosure-of-information" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"From time to time we may monitor and/or record telephone calls between you, the purchaser or other cardholders and us to assure the quality of our customer service or as required by applicable law."}
                    </p>
                    <h2 id="changes-to-our-gift-card-privacy-policy" className="sh-mb-regular sh-mt-large sh-font-bold sh-uppercase sh-text-blue sh-typo-headline-2">
