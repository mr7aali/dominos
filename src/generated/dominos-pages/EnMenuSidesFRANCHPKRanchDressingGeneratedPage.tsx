...
export const metadata: Metadata = {
  "title": "ranch_dressing Near Me",
  "description": "Order your favorite Domino's ranch_dressing online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_RANCHPK/ranch_dressing"
  },
  "robots": "index"
};

export function EnMenuSidesFRANCHPKRanchDressingGeneratedPage() {
  return (
    <>
    <div id="__next">
