...
export const metadata: Metadata = {
  "title": "blue_cheese_dipping_cup Near Me",
  "description": "Order your favorite Domino's blue_cheese_dipping_cup online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/sides/F_Bd/blue_cheese_dipping_cup"
  },
  "robots": "index"
};

export function EnMenuSidesFBdBlueCheeseDippingCupGeneratedPage() {
  return (
    <>
    <div id="__next">
