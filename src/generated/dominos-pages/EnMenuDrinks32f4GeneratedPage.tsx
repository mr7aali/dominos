...
export const metadata: Metadata = {
  "title": "Drinks Near Me | Domino's",
  "description": "Complete your order with Domino's drinks & beverages. Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuDrinks32f4GeneratedPage() {
  return (
    <>
    <div id="__next">
