...
export function EnContentBiometricDataPolicyGeneratedPage() {
  return (
    <>
    <div id="__next">
              ...
              <div className="flex w-full max-w-screen-xl flex-col gap-xx-large self-center px-medium pb-xx-large pt-x-large md:gap-mega-1 md:px-x-large md:pb-mega-1 lg:gap-mega-1 lg:pb-mega-1 lg:pt-mega-1">
                <div className="sh-p-regular">
                  <div>
                    ...
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"The purpose of this policy is to define the policy and procedures for the collection, use, safeguarding, storage, retention, and destruction of biometric data. It is the policy of Domino's Pizza LLC and its parents, subsidiaries, and affiliates (the \"Company\") to protect, use, and store biometric data in accordance with all applicable laws including, but not limited to, the Illinois Biometric Information Privacy Act and the Colorado Privacy Act (C.R.S. §6-1-1306)."}
                    </p>
