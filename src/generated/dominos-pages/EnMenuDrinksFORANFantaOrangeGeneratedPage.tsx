...
export const metadata: Metadata = {
  "title": "Fanta Orange Near Me | Domino's",
  "description": "Order your favorite Domino's Fanta Orange online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/drinks/F_ORAN/fanta_orange"
  },
  "robots": "index"
};

export function EnMenuDrinksFORANFantaOrangeGeneratedPage() {
  return (
    <>
    <div id="__next">
