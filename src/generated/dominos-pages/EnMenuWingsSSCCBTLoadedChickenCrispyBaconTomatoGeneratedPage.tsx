...
export const metadata: Metadata = {
  "title": "Crispy Bacon & Tomato Specialty Chicken | Domino's",
  "description": "Order your favorite Domino's Crispy Bacon & Tomato Specialty Chicken online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/wings/S_SCCBT/loaded_chicken_crispy_bacon_tomato"
  },
  "robots": "index"
};

export function EnMenuWingsSSCCBTLoadedChickenCrispyBaconTomatoGeneratedPage() {
  return (
    <>
    <div id="__next">
