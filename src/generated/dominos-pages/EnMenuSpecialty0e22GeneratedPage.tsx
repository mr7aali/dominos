...
export const metadata: Metadata = {
  "title": "specialty?type=order_delivery Near Me",
  "description": "Order your favorite Domino's specialty?type=order_delivery online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
...
export function EnMenuSpecialty0e22GeneratedPage() {
  return (
    <>
    <div id="__next">
