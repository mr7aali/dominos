...
export const metadata: Metadata = {
  "title": "Wisconsin 6 Cheese Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Wisconsin 6 Cheese pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZCZ/wisconsin_6cheese"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZCZWisconsin6cheeseGeneratedPage() {
  return (
    <>
    <div id="__next">
