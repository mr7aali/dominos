...
export const metadata: Metadata = {
  "title": "Sprite Near Me | Domino's",
  "description": "Order your favorite Domino's Sprite online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/drinks/F_SPRITE/sprite"
  },
  "robots": "index"
};

export function EnMenuDrinksFSPRITESpriteGeneratedPage() {
  return (
    <>
    <div id="__next">
