...
export function EnContentEmailAndTextOffersGeneratedPage() {
  return (
    <>
    <div id="__next">
                ...
                <div className="sh-p-regular">
                  <div>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"  Domino's delivers terrific coupons, online only deals and local money-saving offers through email and text messaging."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"  Sign up today to be the first to get these great offers."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"  SPAM-FREE ZONE. There is zero spam and your email address and phone number are never shared or sold by Domino's Pizza LLC."}
                    </p>
                    <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                      {"  You may unsubscribe from Domino's email and text offers at any time by "}
                    ...
                    <form id="email-and-text-offers-form" className="sh-mt-regular sh-flex sh-flex-col sh-gap-regular sh-w-1/2">
                      <h4 id="select-how-you-would-like-to-receive-dominos-offers" className="sh-mb-regular sh-mt-regular sh-text-blue sh-typo-subhead-2">
                        {"Select how you would like to receive Domino's offers:"}
                      </h4>
                      ...
                      <p className="sh-mb-regular sh-text-ui-dark-cool sh-typo-body-1">
                        {"  Enter/Confirm your address\n  Used to determine your local Domino's store"}
                      </p>
                      <div className="sh-w-full sh-flex sh-flex-row sh-gap-tiny sh-items-center">
