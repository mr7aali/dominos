...
export const metadata: Metadata = {
  "title": "spicy_chicken_bacon_ranch Near Me",
  "description": "Order your favorite Domino's spicy_chicken_bacon_ranch online! Sign up for Domino's email & text offers to get great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZSC/spicy_chicken_bacon_ranch"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZSCSpicyChickenBaconRanchGeneratedPage() {
  return (
    <>
    <div id="__next">
