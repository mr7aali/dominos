...
export const metadata: Metadata = {
  "title": "Memphis BBQ Chicken Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Memphis BBQ Chicken pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZCK/memphis_bbq_chicken"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZCKMemphisBbqChickenGeneratedPage() {
  return (
    <>
    <div id="__next">
