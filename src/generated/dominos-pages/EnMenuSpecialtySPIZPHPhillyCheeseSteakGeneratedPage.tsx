...
export const metadata: Metadata = {
  "title": "Philly Cheese Steak Pizza Near Me | Domino's",
  "description": "Order your favorite Domino's Philly Cheese Steak pizza online! Available for carryout or delivery. Sign up for email & text offers for great deals on your next order.",
  "alternates": {
    "canonical": "/en/menu/specialty/S_PIZPH/philly_cheese_steak"
  },
  "robots": "index"
};

export function EnMenuSpecialtySPIZPHPhillyCheeseSteakGeneratedPage() {
  return (
    <>
    <div id="__next">
